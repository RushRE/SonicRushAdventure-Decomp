...
WandRoom__Main: // 0x02156720
	...
	ldr r0, _02156730 // =WandRoom__Main_2156734
	bx ip
	.align 2, 0
_0215672C: .word SetCurrentTaskMainEvent
_02156730: .word WandRoom__Main_2156734
	arm_func_end WandRoom__Main

	arm_func_start WandRoom__Main_2156734
WandRoom__Main_2156734: // 0x02156734
	stmdb sp!, {r4, lr}
...
_02156788:
	...
	cmp r3, #5
	blo _02156768
	ldr r0, _021567A0 // =WandRoom__Main_21567A4
	bl SetCurrentTaskMainEvent
	ldmia sp!, {r4, pc}
	.align 2, 0
_021567A0: .word WandRoom__Main_21567A4
	arm_func_end WandRoom__Main_2156734

	arm_func_start WandRoom__Main_21567A4
WandRoom__Main_21567A4: // 0x021567A4
	stmdb sp!, {r4, lr}
	bl GetCurrentTaskWork_
	mov r4, r0
	add r0, r4, #4
	...
	bl AnimatorMDL__Draw
	ldmia sp!, {r4, pc}
	arm_func_end WandRoom__Main_21567A4