	...
	arm_func_start exBossSysAdminBiforTask__Main_Init
exBossSysAdminBiforTask__Main_Init: // 0x0215F050
	stmdb sp!, {r3, lr}
	...
	str r0, [r1, #8]
	bl GetExTaskCurrent
	ldr r1, _0215F084 // =exBossSysAdminBiforTask__Main_PickNextAttack
	str r1, [r0]
	bl exBossSysAdminBiforTask__Main_PickNextAttack
	ldmia sp!, {r3, pc}
	.align 2, 0
_0215F080: .word 0x0217626C
_0215F084: .word exBossSysAdminBiforTask__Main_PickNextAttack
	arm_func_end exBossSysAdminBiforTask__Main_Init
...
_0215F0C4: .word 0x0217626C
	...
	arm_func_start exBossSysAdminBiforTask__Main_PickNextAttack
exBossSysAdminBiforTask__Main_PickNextAttack: // 0x0215F0C8
...
_0215F3B4:
	...
	strb r0, [r4, #1]
	bl GetExTaskCurrent
	ldr r1, _0215F7BC // =exBossSysAdminBiforTask__Main_WaitForAttack
	add sp, sp, #8
	str r1, [r0]
	ldmia sp!, {r3, r4, r5, r6, r7, pc}
_0215F424:
...
_0215F7BC: .word exBossSysAdminBiforTask__Main_WaitForAttack
_0215F7C0: .word _mt_math_rand
_0215F7C4: .word 0x00196225
_0215F7C8: .word 0x3C6EF35F
	arm_func_end exBossSysAdminBiforTask__Main_PickNextAttack

	arm_func_start exBossSysAdminBiforTask__Main_WaitForAttack
exBossSysAdminBiforTask__Main_WaitForAttack: // 0x0215F7CC
	stmdb sp!, {r3, lr}
	...
	beq _0215F7F8
	bl GetExTaskCurrent
	ldr r1, _0215F80C // =exBossSysAdminBiforTask__Main_PickNextAttack
	str r1, [r0]
_0215F7F8:
	bl GetExTaskCurrent
	ldr r0, [r0, #8]
...
_0215F80C: .word exBossSysAdminBiforTask__Main_PickNextAttack
	arm_func_end exBossSysAdminBiforTask__Main_WaitForAttack
...
exBossSysAdminBiforTask__Create: // 0x0215F810
	...
	str r1, [sp, #4]
	str r0, [sp, #8]
	ldr r0, _0215F87C // =exBossSysAdminBiforTask__Main_Init
...
_0215F87C: .word exBossSysAdminBiforTask__Main_Init
...
_0215F888: .word exBossSysAdminBiforTask__Func8
	...
	arm_func_start exBossSysAdminTask__MoveRandom
exBossSysAdminTask__MoveRandom: // 0x0215F88C
	stmdb sp!, {r4, lr}
...
_0215F970:
	...
	addlt r0, r0, #0x400
	strlt r0, [r4, #0x3c0]
	bl exBossSysAdminTask__MoveL
	bl exBossSysAdminTask__MoveR
	ldr r1, [r4, #0x3bc]
...
_0215FA0C: .word 0xFFFFFE66
	arm_func_end exBossSysAdminTask__MoveRandom

	arm_func_start exBossSysAdminTask__MoveL
exBossSysAdminTask__MoveL: // 0x0215FA10
	stmdb sp!, {r3, lr}
...
_0215FA94: .word 0x0217626C
	arm_func_end exBossSysAdminTask__MoveL

	arm_func_start exBossSysAdminTask__MoveR
exBossSysAdminTask__MoveR: // 0x0215FA98
	stmdb sp!, {r3, lr}
...
_0215FB18: .word 0x0217626C
	arm_func_end exBossSysAdminTask__MoveR