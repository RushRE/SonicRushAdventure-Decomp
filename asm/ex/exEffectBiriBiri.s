...
exEffectBiriBiriTask__TaskSingleton: // 0x02176480
	...
	arm_func_start ovl09_21645D4
ovl09_21645D4: // 0x021645D4
	stmdb sp!, {r4, r5, lr}
	sub sp, sp, #0xc
	mov r4, r0
	bl ovl09_21636BC
...
_021646D4: .word 0x000004CD
	arm_func_end ovl09_21645D4

	arm_func_start ovl09_21646D8
ovl09_21646D8: // 0x021646D8
...
_021646E8: .word AnimatorSprite__SetAnimation
	arm_func_end ovl09_21646D8

	arm_func_start ovl09_21646EC
ovl09_21646EC: // 0x021646EC
	stmdb sp!, {r3, lr}
	add r0, r0, #0x20
...
exEffectBiriBiriTask__Main: // 0x02164710
	...
	str r0, [r4, #0x140]
	bl GetExTaskCurrent
	ldr r1, _02164778 // =ovl09_21647C8
	str r1, [r0]
	bl ovl09_21647C8
	ldmia sp!, {r4, pc}
	.align 2, 0
_02164774: .word exEffectBigBombTask__ActiveInstanceCount
_02164778: .word ovl09_21647C8
...
_021647C4: .word exEffectBigBombTask__ActiveInstanceCount
	...
	arm_func_start ovl09_21647C8
ovl09_21647C8: // 0x021647C8
	stmdb sp!, {r4, lr}
	bl GetExTaskWorkCurrent_
	mov r4, r0
	add r0, r4, #0xc
...
_021647F4:
	...
	blx r0
	ldmia sp!, {r4, pc}
	arm_func_end ovl09_21647C8

	arm_func_start ovl09_2164810
ovl09_2164810: // 0x02164810
	stmdb sp!, {r4, lr}
	bl GetExTaskWorkCurrent_
	mov r4, r0
	add r0, r4, #0xc
	...
	bl ovl09_21641F0
	bl GetExTaskCurrent
	ldr r1, _02164844 // =ovl09_2164848
	str r1, [r0]
	bl ovl09_2164848
	ldmia sp!, {r4, pc}
	.align 2, 0
_02164844: .word ovl09_2164848
	arm_func_end ovl09_2164810

	arm_func_start ovl09_2164848
ovl09_2164848: // 0x02164848
	stmdb sp!, {r4, lr}
	bl GetExTaskWorkCurrent_
	mov r4, r0
	add r0, r4, #0xc
