...
_0204E94C:
	...
	mov sb, sb, lsl #0x10
	tst sl, sb, lsr #16
	addne sb, sl, r2, lsl r5
	movne sb, sb, lsl #0x10
	add r5, r5, #4
	movne sl, sb, lsr #0x10
	cmp r5, #8
	blt _0204E94C
_0204E970:
	ldrh r2, [r8, r4]
...
_0204F5D8:
	tst sb, r5, lsl r8
	addne sb, sb, r0, lsl r8
	andeq lr, sl, r5, lsl r8
	add r8, r8, #8
	orreq sb, sb, lr
	cmp r8, #0x20
	blt _0204F5D8
...
_0204F60C:
	tst r8, r4, lsl sl
	addne r8, r8, r0, lsl sl
	andeq lr, sb, r4, lsl sl
	add sl, sl, #8
	orreq r8, r8, lr
	cmp sl, #0x20
	blt _0204F60C
