...
ViDock__Func_215E578: // 0x0215E578
	...
	mov r5, r0
	mov r0, #0
	bl HubState__Func_2152E74
	cmp r0, #0
	beq _0215E5CC
	mov r0, #0
	bl HubState__GetPlayerInfo
	mov r1, r0
	add r0, r5, #0xe00
	bl CPPHelpers__VEC_Copy_Alt
	mov r0, #0
	bl HubState__Func_2152EA4
	add r1, r5, #0xe00
	strh r0, [r1, #0x30]
	ldrh r0, [r1, #0x30]
	strh r0, [r1, #0x32]
...
_0215E5EC:
	mov r0, r6
	bl HubState__Func_2152F20
	cmp r0, #0
	beq _0215E630
	mov r0, r6
	bl HubState__GetNpcInfo
	mov r1, r0
	add r0, r7, #8
	bl CPPHelpers__VEC_Copy_Alt
	cmp r4, #0
	beq _0215E624
	mov r0, r6
	bl HubState__Func_2152F58
	strh r0, [r7, #0x38]
_0215E624:
	mov r0, r6
	bl HubState__Func_2152F70
	str r0, [r7, #0x30c]
_0215E630:
	mov r1, r7
	add r0, r5, #0x1000
