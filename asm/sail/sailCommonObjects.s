...
SailJetBoatCloud__CreateUnknown: // 0x02165F38
	...
	rsb r4, r4, #0
	ldr fp, _021660AC // =FX_SinCosTable_
...
_02167994:
	...
	beq _02168054
	ldr r0, [r5, #0x164]
	ldr fp, _02168274 // =_obj_disp_rand
	ldr r0, [r0, #0x34]
...
_0216838C:
	...
	ldr sb, _02168810 // =0x3C6EF35F
	ldr fp, _02168814 // =0x0218B9AC
	mov r0, r0, lsl #1
	ldrh r0, [fp, r0]
	mla fp, sl, r8, sb
	adc r2, r2, #0
...
_021688B4:
	...
	b _02168C14
_021689FC:
	ldr sb, _02168C5C // =_obj_disp_rand
	mov r0, r6, asr #0x1f
	ldr r5, [sb]
	mov ip, r0, lsl #0xa
	mla r1, r5, r2, r3
...
_02168CD4:
	...
	b _02168E0C
_02168DA0:
	ldr sl, _02169034 // =_obj_disp_rand
