...
BossF__Create: // 0x02167D9C
	...
	ldr fp, _0216820C // =bossAssetFiles
	mov sb, #0
	add sl, r8, #0x2c
	mov r4, #5
_0216817C:
...
_02168480:
	...
	mov sb, #0
	add r5, r7, #0xc
	ldr fp, _02168684 // =bossAssetFiles
	b _021685F0
_021685A4:
	add r0, sp, #0xc
	add r1, sb, #0x14
...
_0216C0AC: // jump table
	...
	b _0216C4D0 // case 6
	b _0216C4D0 // case 7
	ldmia sp!, {r3, r4, r5, r6, r7, r8, sb, pc} // case 8
...
_0216C0E4:
	...
	subs r0, r0, #1
	str r0, [r5, #0x2c]
	ldmplia sp!, {r3, r4, r5, r6, r7, r8, sb, pc}
...
_02174500:
	...
	cmpne r0, r1
	bne _021746A0
	ldr sb, _021746C4 // =_obj_disp_rand
	mov r6, #0
	mov r4, #0x14
	mov fp, #0x1000
	mov r8, #0x180
