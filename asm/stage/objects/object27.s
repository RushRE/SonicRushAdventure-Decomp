	...
	arm_func_start Object27__Create
Object27__Create: // 0x02161E64
	...
	ldr r1, _02161FC8 // =ovl00_2162138
	mov r0, r4
	str r1, [r4, #0x23c]
	ldr r2, [r4, #0x230]
	mov r1, #0
	...
	ldr r1, _02161FCC // =ovl00_2161FD0
	mov r0, r4
	str r1, [r4, #0xf4]
	add sp, sp, #0xc
...
_02161FC8: .word ovl00_2162138
_02161FCC: .word ovl00_2161FD0
	arm_func_end Object27__Create

	arm_func_start ovl00_2161FD0
ovl00_2161FD0: // 0x02161FD0
	stmdb sp!, {r4, lr}
	mov r4, r0
	ldr r1, [r4, #0x35c]
	cmp r1, #0
...
_02162120:
	...
	strh r0, [r4, #0x34]
	ldmia sp!, {r4, pc}
	arm_func_end ovl00_2161FD0

	arm_func_start ovl00_2162138
ovl00_2162138: // 0x02162138
	stmdb sp!, {r3, lr}
	ldr r1, [r1, #0x1c]
	ldr r0, [r0, #0x1c]
	cmp r1, #0
