	...
	arm_func_start Object50__Create
Object50__Create: // 0x0216BB24
...
_0216BD24:
	...
	b _0216BD40
_0216BD38:
	ldr r0, _0216BD60 // =ovl00_216BD64
	str r0, [r6, #0xf4]
_0216BD40:
	mov r0, r6
	add sp, sp, #0x10
...
_0216BD60: .word ovl00_216BD64
	arm_func_end Object50__Create

	arm_func_start ovl00_216BD64
ovl00_216BD64: // 0x0216BD64
...
_0216BDF8: .word mapCamera
	arm_func_end ovl00_216BD64

	arm_func_start ovl00_216BDFC
ovl00_216BDFC: // 0x0216BDFC
	ldr r2, [r0, #0x340]
	mov r3, #0
	ldrh r2, [r2, #4]
	tst r2, #1
