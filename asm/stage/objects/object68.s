	...
	arm_func_start Object68__Create
Object68__Create: // 0x0217AECC
...
_0217B134: .word ovl00_217BE24
	arm_func_end Object68__Create

	arm_func_start Cannon2__Destructor
Cannon2__Destructor: // 0x0217B138
...
_0217B14C:
	...
	arm_func_end Cannon2__Destructor
...
ovl00_217B474: // 0x0217B474
	ldr r1, _0217B484 // =Object103__dword_218A394
	ldr r1, [r1, #4]
	str r1, [r0, #0x58]
	bx lr
	.align 2, 0
_0217B484: .word Object103__dword_218A394
...
ovl00_217B488: // 0x0217B488
	...
	mov r4, r0
	ldr r1, _0217B67C // =Object103__dword_218A394
	ldr r2, [r4, #0x20]
	ldr r0, [r1, #4]
	str r2, [sp, #0x10]
	cmp r0, #0
	...
	ldr r2, [r4, #0x44]
	ldr r1, [r4, #0x50]
	ldr r0, _0217B67C // =Object103__dword_218A394
	add r1, r2, r1
	str r1, [sp, #0x14]
	ldr r2, [r4, #0x48]
	ldr r1, [r0, #4]
	...
	ldmia sp!, {r4, r5, pc}
	.align 2, 0
_0217B67C: .word Object103__dword_218A394
...
ovl00_217B7A8: // 0x0217B7A8
	ldr r1, _0217B7D8 // =Object103__dword_218A394
	ldr r1, [r1]
	cmp r1, #0x1f4000
	ldreq r1, [r0, #0x20]
	orreq r1, r1, #0x20
	...
	bx lr
	.align 2, 0
_0217B7D8: .word Object103__dword_218A394
...
_0217B828:
	...
	arm_func_start Object103__Destructor
Object103__Destructor: // 0x0217B844
	ldr r1, _0217B860 // =Object103__dword_218A394
	mov r2, #0
	str r2, [r1, #4]
	str r2, [r1]
	...
	bx ip
	.align 2, 0
_0217B860: .word Object103__dword_218A394
_0217B864: .word GameObject__Destructor
	arm_func_end Object103__Destructor

	arm_func_start Object103__State_217B868
Object103__State_217B868: // 0x0217B868
	...
	beq _0217B8A4
	ldr r1, [r4, #0x18]
	ldr r0, _0217BBF8 // =Object103__dword_218A394
	orr r1, r1, #4
	str r1, [r4, #0x18]
	mov r1, #0
	str r1, [r0, #4]
...
_0217BA1C:
	...
	add r0, r4, #0x300
	strh r3, [r0, #0x76]
	ldr r1, _0217BBF8 // =Object103__dword_218A394
	sub r0, r3, #0x190000
	ldr r2, [r1, #4]
	add r2, r2, #0x190000
	str r2, [r4, #0x4c]
...
_0217BB84:
	...
	ldmia sp!, {r3, r4, r5, r6, r7, r8, sb, pc}
	.align 2, 0
_0217BBF8: .word Object103__dword_218A394
	arm_func_end Object103__State_217B868
...
ovl00_217BC38: // 0x0217BC38
	...
	bl GetCurrentTaskWork_
	mov r4, r0
	ldr r0, _0217BD8C // =Object103__dword_218A394
	ldr r2, [r4, #0x20]
	ldr r1, [r0, #8]
	bic r2, r2, #4
	str r2, [sp, #0x10]
...
_0217BD8C: .word Object103__dword_218A394
