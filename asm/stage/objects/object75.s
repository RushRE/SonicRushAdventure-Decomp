	...
	arm_func_start Object75__Create
Object75__Create: // 0x021817E0
...
_02181990: .word ovl00_2181F9C
	arm_func_end Object75__Create

	arm_func_start Object77__Create
Object77__Create: // 0x02181994
	stmdb sp!, {r4, r5, r6, r7, lr}
	sub sp, sp, #0xc
	mov r3, #0x1800
	mov r7, r0
...
ovl00_2182184: // 0x02182184
	...
	cmp r0, #1
	ldreq r1, [r5, #0xf4]
	ldreq r0, _0218222C // =Player__Func_2023A4C
	cmpeq r1, r0
	addne sp, sp, #8
	ldmneia sp!, {r3, r4, r5, pc}
	mov r0, r5
...
_0218220C:
	...
	ldmia sp!, {r3, r4, r5, pc}
	.align 2, 0
_0218222C: .word Player__Func_2023A4C
