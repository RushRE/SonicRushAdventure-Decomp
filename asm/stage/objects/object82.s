...
Task__Unknown2184B2C__Singleton: // 0x0218A3D8
	...
	arm_func_start Object82__Create
Object82__Create: // 0x02183A44
	...
	ldr r1, _02183C44 // =WaterGrindRail__Destructor
	mov r3, r2
	str r4, [sp, #8]
	bl TaskCreate_
	mov r4, r0
	...
	strh r1, [r0, #0xf2]
	ldrsb r0, [r7, #6]
	bl Task__OVL00Unknown2184B2C__Create
	bl AllocSndHandle
	str r0, [r4, #0x138]
	mov r0, r4
	add sp, sp, #0xc
...
_02183C44: .word WaterGrindRail__Destructor
...
_02183C60: .word aDfGmkWaterGrai
	arm_func_end Object82__Create

	arm_func_start Object83__Create
Object83__Create: // 0x02183C64
	stmdb sp!, {r4, r5, r6, r7, lr}
	sub sp, sp, #0xc
	...
	ldr r1, _02183DE8 // =WaterGrindRail__Destructor
	mov r3, r2
	str r4, [sp, #8]
	bl TaskCreate_
	mov r4, r0
...
_02184B04:
	...
	arm_func_start Task__OVL00Unknown2184B2C__Create
Task__OVL00Unknown2184B2C__Create: // 0x02184B2C
...
_02184B68:
	...
	ldr r1, _02184D20 // =Task__OVL00Unknown2184B2C__Destructor
	mov r3, r2
	str r5, [sp, #8]
	bl TaskCreate_
	mov r5, r0
...
_02184C28:
	...
	mov r1, #0x16
	bl StageTask__SetOAMOrder
	ldr r1, _02184D30 // =Task__OVL00Unknown2184B2C__Draw
	add r0, sl, #0x168
	str r1, [sl, #0xfc]
	add sp, sp, #0xc
	ldmia sp!, {r4, r5, r6, r7, r8, sb, sl, fp, pc}
...
_02184D20: .word Task__OVL00Unknown2184B2C__Destructor
_02184D24: .word _02189D28
_02184D28: .word gameArchiveStage
_02184D2C: .word aActAcGmkWaterG
_02184D30: .word Task__OVL00Unknown2184B2C__Draw
	arm_func_end Task__OVL00Unknown2184B2C__Create
...
_02184D7C: .word Task__Unknown2184B2C__Singleton
	...
	arm_func_start Task__OVL00Unknown2184B2C__Destructor
Task__OVL00Unknown2184B2C__Destructor: // 0x02184D80
	stmdb sp!, {r4, lr}
	mov r4, r0
	bl GetTaskWork_
	add r1, r0, #0x400
...
_02184DB4: .word Task__Unknown2184B2C__Singleton
	arm_func_end Task__OVL00Unknown2184B2C__Destructor
...
_02184E6C: .word Task__Unknown2184B2C__Singleton
	...
	arm_func_start Task__OVL00Unknown2184B2C__Draw
Task__OVL00Unknown2184B2C__Draw: // 0x02184E70
...
_02184E84:
	...
	arm_func_end Task__OVL00Unknown2184B2C__Draw
