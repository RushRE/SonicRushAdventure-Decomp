...
NOT_DECOMPILED void exDrawReqTask__InitModel(void);
...
NOT_DECOMPILED void exDrawReqTask__Model__Animate(void);
NOT_DECOMPILED void exDrawReqTask__Model__Draw(void);
...
NOT_DECOMPILED void exDrawReqTask__AddRequest(void);
