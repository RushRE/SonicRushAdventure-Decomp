...
RUSH_INLINE void PlaySailSfx(enum SND_SAIL_SEQARC_ARC_VOYAGE_SE sfxID)
{
    PlaySfxEx(NULL, AUDIOMANAGER_PLAYERNO_AUTO, AUDIOMANAGER_BANKNO_AUTO, AUDIOMANAGER_PLAYERPRIO_AUTO, SND_SAIL_SEQARC_ARC_VOYAGE_SE, sfxID);
}

RUSH_INLINE void PlayHandleSailSfx(NNSSndHandle *handle, enum SND_SAIL_SEQARC_ARC_VOYAGE_SE sfxID)
{
    PlaySfxEx(handle, AUDIOMANAGER_PLAYERNO_AUTO, AUDIOMANAGER_BANKNO_AUTO, AUDIOMANAGER_PLAYERPRIO_AUTO, SND_SAIL_SEQARC_ARC_VOYAGE_SE, sfxID);
}
