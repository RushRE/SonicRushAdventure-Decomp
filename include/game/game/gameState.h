...
enum StageID_
{
    ...
    STAGE_COUNT,
    STAGE_COUNT_NON_OPTIONAL   = STAGE_BOSS_FINAL + 1,
    STAGE_COUNT_NO_RACES       = STAGE_HIDDEN_ISLAND_R1,
    STAGE_COUNT_NO_RACES_NO_VS = STAGE_HIDDEN_ISLAND_VS1,
};
typedef u16 StageID;
...
enum ZoneID_
{
    ...
    // not used in regular stage contexts, but _is_ used in save context instead of hidden islands
