...
void SaveGame__Func_205BDC8(void);
...
SaveGameUnknown2119CCC *SaveGame__Func_205C00C(void);
...
void SaveGame__UnknownTable2Func_205C720(void);
void SaveGame__UnknownTable2Func_205C780(void);
void SaveGame__UnknownTable2Func_205C7E8(void);
void SaveGame__UnknownTable2Func_205C904(void);
void SaveGame__UnknownTable2Func_205C91C(void);
...
void SaveGame__UnknownTable1Func_205CB60(SaveGameUnknown2119CCC *a1);
...
void SaveGame__Func_205CF9C(void);
...
void SaveGame__Func_205D150(void);
...
void SaveGame__Func_205D520(void);
...
void SaveGame__Func_205D65C(void);
void SaveGame__Func_205D758(void);
BOOL SaveGame__GetShipUpgradeStatus(u16 id);
BOOL SaveGame__GetShipUpgradeStatus_(u16 id, u32 flags);
...
void SaveGame__SetIslandProgress(SaveGameProgress *progress, s32 id, u8 state);
...
BOOL SaveGame__HasSolEmerald(SaveBlockStage *work, u32 id);
u32 SaveGame__GetSolEmeraldCount(SaveBlockStage *work);
void SaveGame__SetSolEmeraldCollected(SaveBlockStage *work, u32 id);
...
void SaveGame__Block4__GetLastUsedCharacter(void);
