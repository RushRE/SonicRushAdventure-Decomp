...
void Boss2Arm__CheckCanDraw(Boss2Arm *work);
...
void Boss2Arm__Func_215EBF0(Boss2Arm *work, s16 angle, s16 angleSpeed);
...
void Boss2Ball__Func_215F490(void);
...
void Boss2Ball__Action_Hit(Boss2Ball* work);
