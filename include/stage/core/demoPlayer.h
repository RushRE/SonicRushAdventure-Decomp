...
enum FileList_BundleGM_DEMOPLAY
{
    BUNDLE_GM_DEMOPLAY_FILE_DEMO_TEXT_JPN_BAC,
    BUNDLE_GM_DEMOPLAY_FILE_DEMO_TEXT_ENG_BAC,
    BUNDLE_GM_DEMOPLAY_FILE_DEMO_TEXT_FRA_BAC,
    BUNDLE_GM_DEMOPLAY_FILE_DEMO_TEXT_DEU_BAC,
    BUNDLE_GM_DEMOPLAY_FILE_DEMO_TEXT_ITA_BAC,
    BUNDLE_GM_DEMOPLAY_FILE_DEMO_TEXT_SPA_BAC,
};
