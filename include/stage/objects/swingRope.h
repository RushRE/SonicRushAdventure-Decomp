...
void SwingRope__Action_Init(RotatingHanger *work);
void SwingRope__State_2162520(RotatingHanger *work);
void SwingRope__Draw(void);
void SwingRope__Collide(void);
void SwingRope__OnDefend(OBS_RECT_WORK *rect1, OBS_RECT_WORK *rect2);
void SwingRope__HandleNodePositions(RotatingHanger *work);
