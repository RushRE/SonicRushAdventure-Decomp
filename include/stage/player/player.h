...
#define PLAYER_DEFPOWER_NORMAL (0x3F)
#define PLAYER_HITPOWER_NORMAL (0x40)
...
void Player__State_201B5A0(Player *player);
...
void Player__Gimmick_201BDC0(Player *player, s32 a2, s32 a3, s32 a4, u16 a5);
void Player__Func_201BF3C(Player *player);
void Player__Func_201C1EC(Player *player, s32 a2, s32 a3, s16 a4);
void Player__Func_201C384(Player *player, s32 a2, s32 a3, s32 a4, s32 a5, s32 a6, s32 a7);
void Player__Gimmick_201C80C(Player *player, GameObjectTask *other, s32 value1, s32 timer);
void Player__State_201C938(Player *player);
...
void Player__State_201D3E0(Player *player);
void Player__Action_MushroomBounce(Player *player, s32 a2, s32 a3, s32 a4);
void Player__Func_201D684(Player *player, s32 a2, s32 a3, s32 a4);
void Player__State_201D748(Player *player);
void Player__Func_201D7BC(Player *player, s32 a2);
void Player__State_201D874(Player *player);
...
void Player__State_201DE24(Player *player);
void Player__Gimmick_WaterRun(Player *player);
void Player__State_WaterRun(Player *player);
void Player__Gimmick_201E3F8(Player *player, s32 a2, s32 a3);
void Player__Func_201E540(Player *player);
void Player__Gimmick_201E7DC(Player *player, s32 a2, s32 a3, s32 a4, s32 a5, u32 a6);
void Player__Func_201E918(Player *player);
void Player__Gimmick_DreamWing(Player *player, GameObjectTask *other, fx32 velX, fx32 velY, s32 a5);
void Player__State_DreamWing(Player *player);
void Player__Gimmick_201ED44(Player *player, StageTask *other, s32 a3, s32 a4, s32 a5, s32 a6);
void Player__Func_201EEE0(Player *player, s32 a2, s32 a3, s32 a4);
void Player__Func_201F05C(Player *player, StageTaskState a2, s32 a3, s32 a4, s32 a5, u32 a6);
void Player__Func_201F1C4(Player *player, s32 a2, s32 a3, s32 a4);
void Player__Gimmick_IcicleGrab(Player *player, u32 a2, s32 a3);
void Player__Func_201F4FC(Player *player);
void Player__Gimmick_IcicleLand(Player *player, s32 a2);
void Player__Func_201F940(Player *player);
void Player__Func_201FA84(Player *player);
...
void Player__Func_201FFD4(Player *player);
void Player__Func_2020098(Player *player);
void Player__Func_202015C(Player *player);
void Player__Func_2020220(Player *player);
void Player__Func_20202E4(Player *player, StageTask *other);
void Player__Func_20203B4(Player *player);
void Player__Func_2020420(Player *player, StageTask *other, fx32 velX, fx32 velY);
void Player__Gimmick_202047C(Player *player, s32 a2, s32 a3);
void Player__Func_20205E8(Player *player);
void Player__Func_2020C00(Player *player, s32 a2);
void Player__Func_2020DB8(Player *player);
void Player__Func_20210D0(Player *player);
void Player__Func_2021188(Player *player, u32 a2);
void Player__Func_2021204(Player *player);
void Player__Action_CraneGrab(Player *player, u32 a2);
void Player__Func_20212C8(Player *player, s32 a2, s32 a3);
void Player__Func_202135C(Player *player, s32 a2, s32 a3, s32 a4);
void Player__Gimmick_2021394(Player *player, StageTask *other);
void Player__Func_202146C(Player *player);
void Player__Func_202178C(Player *player, StageTask *other, s32 a3);
void Player__Func_2021848(Player *player);
void Player__OnDefend_Unknown(OBS_RECT_WORK *rect1, OBS_RECT_WORK *rect2);
void Player__Func_2021A84(Player *player, StageTask *other);
void Player__Func_2021AE8(Player *player, StageTask *other);
void Player__Func_2021B44(Player *player, StageTask *other);
void Player__Func_2021B84(Player *player, StageTask *other);
void Player__Action_AnchorRope(Player *player);
void Player__Func_2021CE8(Player *player, StageTask *other);
void Player__Func_2021DD4(Player *player);
void Player__Gimmick_2021E9C(Player *player, StageTask *other);
void Player__Func_2021FA8(Player *player);
void Player__Action_Trampoline(Player *player, fx32 velX, fx32 velY);
void Player__Gimmick_2022108(Player *player, StageTask *other, s32 a3);
void Player__Func_20222E4(Player *player);
void Player__Func_20223F8(Player *player);
void Player__Func_20224BC(Player *player);
void Player__Func_2022694(Player *player);
void Player__Action_PRCannon(Player *player, StageTask *other);
void Player__State_CannonLanched(Player *player);
void Player__Func_2022C40(Player *player);
void Player__Func_2022CD4(Player *player);
void Player__Func_2022D24(Player *player, u8 a2);
...
void Player__State_JumpBoxPlaneSwitchLaunch(Player *player);
...
void Player__Func_202379C(Player *player, StageTask *other);
void Player__Func_2023858(Player *player);
void Player__Gimmick_2023944(Player *player, StageTask *other);
void Player__Func_2023A4C(Player *player);
void Player__Func_2023EB4(Player *player);
void Player__Func_2023ED4(Player *player);
void Player__Func_2023FC8(Player *player);
void Player__OnDefend_Regular4(OBS_RECT_WORK *rect1, OBS_RECT_WORK *rect2);
void Player__Func_2024054(Player *player, StageTask *other);
void Player__Gimmick_AirSwitch(Player *player, StageTask *other, s32 a3, s32 a4, s32 a5);
void Player__State_AirSwitch(Player *player);
void Player__Gimmick_202447C(Player *player, StageTask *other, s32 a3);
void Player__Func_20245AC(Player *player);
void Player__Gimmick_20246FC(Player *player, StageTask *other);
void Player__Func_2024814(Player *player);
void Player__Gimmick_Bungee(Player *player, StageTask *other, u32 a3, u32 a4);
void Player__State_Bungee(Player *player);
void Player__Action_SpringRope(Player *player, GameObjectTask *other, s32 timer);
void Player__State_SpringRope(Player *player);
