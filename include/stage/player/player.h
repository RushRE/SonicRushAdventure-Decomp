...
void Player__State_201BF3C(Player *work);
...
void Player__Gimmick_201ED44(Player *player, GameObjectTask *other, s32 a3, s32 a4, s32 a5, s32 a6);
...
void Player__State_201FA84(Player *work);
...
void Player__Func_20202E4(Player *player, GameObjectTask *other);
void Player__Func_20203B4(Player *player);
void Player__Func_2020420(Player *player, GameObjectTask *other, fx32 velX, fx32 velY);
...
void Player__Gimmick_2022108(Player *player, GameObjectTask *other, s32 a3);
void Player__State_20222E4(Player *work);
...
void Player__State_CannonLanched(Player *work);
...
void Player__Gimmick_2023944(Player *player, GameObjectTask *other);
void Player__State_2023A4C(Player *work);
void Player__Func_2023EB4(Player *player);
void Player__State_2023ED4(Player *work);
