...
enum StageTaskMoveFlags_
{
    ...
    STAGE_TASK_MOVE_FLAG_TOUCHING_FLOOR                  = 1 << 0, // object is colliding with the floor
    STAGE_TASK_MOVE_FLAG_TOUCHING_CEILING                = 1 << 1, // object is colliding with the ceiling
    STAGE_TASK_MOVE_FLAG_TOUCHING_LWALL                  = 1 << 2, // object is colliding with the wall to its left
    STAGE_TASK_MOVE_FLAG_TOUCHING_RWALL                  = 1 << 3, // object is colliding with the wall to its right
    STAGE_TASK_MOVE_FLAG_IS_FALLING                      = 1 << 4,
    STAGE_TASK_MOVE_FLAG_ALLOW_TOP_SOLID                 = 1 << 5,
    STAGE_TASK_MOVE_FLAG_USE_SLOPE_FORCES                = 1 << 6,
    STAGE_TASK_MOVE_FLAG_HAS_GRAVITY                     = 1 << 7,
    STAGE_TASK_MOVE_FLAG_DISABLE_COLLIDE_EVENT           = 1 << 8,
    STAGE_TASK_MOVE_FLAG_DISABLE_OBJ_COLLISIONS          = 1 << 9,
    STAGE_TASK_MOVE_FLAG_DISABLE_X_COLLISION_CHECK       = 1 << 10,
    STAGE_TASK_MOVE_FLAG_DISABLE_Y_COLLISION_CHECK       = 1 << 11,
    STAGE_TASK_MOVE_FLAG_DISABLE_MAP_COLLISIONS          = 1 << 12,
    STAGE_TASK_MOVE_FLAG_DISABLE_MOVE_EVENT              = 1 << 13,
    STAGE_TASK_MOVE_FLAG_DISABLE_SPEED_LOSS_ON_IMPACT    = 1 << 14, // Disables velocity being set to 0 on wall collisions
    STAGE_TASK_MOVE_FLAG_DISABLE_SLOPE_ANGLES            = 1 << 15,
    STAGE_TASK_MOVE_FLAG_DO_COL_VIB_CHECK                = 1 << 16,
    STAGE_TASK_MOVE_FLAG_USE_SLOPE_ACCELERATION          = 1 << 17,
    STAGE_TASK_MOVE_FLAG_DISABLE_SLOPE_IDLE_ACCELERATION = 1 << 18,
    STAGE_TASK_MOVE_FLAG_LIMIT_MAP_BOUNDS                = 1 << 19,
    STAGE_TASK_MOVE_FLAG_NO_BOTTOM_COLLISION             = 1 << 20,
    STAGE_TASK_MOVE_FLAG_PRECISE_FLOOR_CHECKS            = 1 << 21, // Check every pixel along the rect's width
    STAGE_TASK_MOVE_FLAG_PREV_TOUCHING_FLOOR             = 1 << 22,
    STAGE_TASK_MOVE_FLAG_STEP_TOWARDS_ANGLES             = 1 << 23, // Use ObjRoopMove16 instead of setting the angle exactly
    STAGE_TASK_MOVE_FLAG_1000000                         = 1 << 24,
    STAGE_TASK_MOVE_FLAG_CAN_PUSH                        = 1 << 25,
    STAGE_TASK_MOVE_FLAG_CAN_BE_PUSHED                   = 1 << 26,
    STAGE_TASK_MOVE_FLAG_DISABLE_AUTO_SCROLL             = 1 << 27,
    STAGE_TASK_MOVE_FLAG_DISABLE_FLOW                    = 1 << 28,
    STAGE_TASK_MOVE_FLAG_DISABLE_ANGLE_UPDATES           = 1 << 29, // Collision never updates angle
    STAGE_TASK_MOVE_FLAG_40000000                        = 1 << 30,
    STAGE_TASK_MOVE_FLAG_80000000                        = 1 << 31,
