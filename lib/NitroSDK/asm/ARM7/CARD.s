...
CARD_SetThreadPriority: // 0x0380333C
	...
	bx lr
	.align 2, 0
_03803380: .word cardi_common
	arm_func_end CARD_SetThreadPriority

	arm_func_start CARD_Enable
CARD_Enable: // 0x03803384
	ldr r1, _03803390 // =CARDi_EnableFlag
	str r0, [r1]
	bx lr
	.align 2, 0
_03803390: .word CARDi_EnableFlag
...
CARDi_InitCommon: // 0x03803394
	...
	ldr r3, _03803438 // =status_checked_3333
	bl OS_CreateThread
	ldr r0, _03803430 // =0x03809E28
...
_03803420:
	...
	bx lr
	.align 2, 0
_0380342C: .word cardi_common
_03803430: .word 0x03809E28
_03803434: .word CARDi_TaskThread
_03803438: .word status_checked_3333
...
CARDi_SetWriteProtectCore: // 0x03803444
	...
	add r7, sp, #0
	mov r6, #0
	ldr r5, _038034DC // =CARDi_CommWriteCore
	mov r4, #5
_03803488:
...
_038034CC:
	...
	bx lr
	.align 2, 0
_038034D8: .word cardi_common
_038034DC: .word CARDi_CommWriteCore
...
CARDi_EraseChipCore: // 0x038034E0
	...
	mov r1, #0
	mov r2, #1
	ldr r3, _03803534 // =CARDi_CommWriteCore
	bl CARDi_CommArray
	ldr r0, [r4, #0x34]
	ldr r1, [r4, #0x38]
	bl CARDi_CommandEnd
_03803524:
	...
	bx lr
	.align 2, 0
_0380352C: .word cardi_common
_03803530: .word 0x03807F54
_03803534: .word CARDi_CommWriteCore
...
CARDi_VerifyBackupCore: // 0x038035CC
	...
	mov r1, #0
	mov r2, r5
	ldr r3, _03803670 // =CARDi_CommVerifyCore
	bl CARDi_CommArray
	mov r0, #0
	mov r1, r0
	bl CARDi_CommandEnd
...
_0380365C:
	...
	bx lr
	.align 2, 0
_03803668: .word cardi_common
_0380366C: .word cardi_param
_03803670: .word CARDi_CommVerifyCore
...
_038036B4:
	...
	ldr r1, [sp]
	mov r2, r5
	ldr r3, _03803734 // =CARDi_CommWriteCore
	bl CARDi_CommArray
	ldr r0, [r7, #0x2c]
	ldr r1, [r7, #0x30]
	bl CARDi_CommandEnd
...
_03803724:
	...
	bx lr
	.align 2, 0
_03803730: .word cardi_common
_03803734: .word CARDi_CommWriteCore
...
_03803778:
	...
	mov r1, r11
	mov r2, r5
	ldr r3, _038037F8 // =CARDi_CommWriteCore
	bl CARDi_CommArray
	ldr r0, [r7, #0x28]
	mov r1, r11
	bl CARDi_CommandEnd
...
_038037E8:
	...
	bx lr
	.align 2, 0
_038037F4: .word cardi_common
_038037F8: .word CARDi_CommWriteCore
...
CARDi_ReadBackupCore: // 0x038037FC
	...
	mov r1, r5
	mov r2, r4
	ldr r3, _03803868 // =CARDi_CommReadCore
	bl CARDi_CommArray
	mov r0, #0
	mov r1, r0
	bl CARDi_CommandEnd
_0380385C:
	...
	bx lr
	.align 2, 0
_03803864: .word cardi_common
_03803868: .word CARDi_CommReadCore
...
CARDi_InitStatusRegister: // 0x0380386C
	...
	mov r1, #0
	mov r2, #1
	ldr r3, _03803910 // =CARDi_CommWriteCore
	bl CARDi_CommArray
	mov r0, #0
	add r1, sp, #1
	mov r2, #1
	ldr r3, _03803914 // =CARDi_CommReadCore
	bl CARDi_CommArray
	mov r0, #0
	mov r1, r0
	bl CARDi_CommandEnd
...
_038038FC:
	...
	bx lr
	.align 2, 0
_03803908: .word cardi_common
_0380390C: .word status_checked_3333
_03803910: .word CARDi_CommWriteCore
_03803914: .word CARDi_CommReadCore
...
_0380399C:
	...
	mov r1, #0
	add r2, r2, #1
	ldr r3, _038039C0 // =CARDi_CommWriteCore
	bl CARDi_CommArray
	add sp, sp, #4
	ldmia sp!, {lr}
	bx lr
	.align 2, 0
_038039BC: .word cardi_common
_038039C0: .word CARDi_CommWriteCore
...
CARDi_WriteEnable: // 0x038039C4
	...
	mov r1, #0
	mov r2, #1
	ldr r3, _03803A04 // =CARDi_CommWriteCore
	bl CARDi_CommArray
	mov r0, #0
	mov r1, r0
	bl CARDi_CommandEnd
...
_03803A04: .word CARDi_CommWriteCore
	arm_func_end CARDi_WriteEnable

	arm_func_start CARDi_CommVerifyCore
CARDi_CommVerifyCore: // 0x03803A08
	mov r2, #0
...
CARDi_CommandCheckBusy: // 0x03803BD4
	...
	mov r1, #0
	mov r2, #1
	ldr r3, _03803C38 // =CARDi_CommWriteCore
	bl CARDi_CommArray
	mov r0, #0
	add r1, sp, #0
	mov r2, #1
	ldr r3, _03803C3C // =CARDi_CommReadCore
	bl CARDi_CommArray
	mov r0, #0
	mov r1, r0
	bl CARDi_CommandEnd
...
_03803C38: .word CARDi_CommWriteCore
_03803C3C: .word CARDi_CommReadCore
...
CARD_Init: // 0x03803CE0
	...
	str r1, [r2, #0x3c]
	str r1, [r2, #0x40]
	ldr r0, _03803D54 // =cardi_rom_base
	str r1, [r0]
	bl CARDi_InitCommon
	bl CARDi_GetRomAccessor
	ldr r1, _03803D58 // =rom_stat
	str r0, [r1]
...
_03803D44:
	...
	bx lr
	.align 2, 0
_03803D50: .word cardi_common
_03803D54: .word cardi_rom_base
_03803D58: .word rom_stat
	arm_func_end CARD_Init

	arm_func_start CARDi_ReadRomID
CARDi_ReadRomID: // 0x03803D5C
	stmdb sp!, {r4, r5, r6, r7, r8, lr}
	ldr r5, _03803E20 // =cardi_common
	bl OS_DisableInterrupts
	mov r4, r0
	add r6, r5, #0xf4
	b _03803D7C
...
_03804240:
	...
	arm_func_start CARDi_TerminateARM7
CARDi_TerminateARM7: // 0x03804264
	stmdb sp!, {lr}
	sub sp, sp, #4
	mov r0, #0
	...
	ldmia sp!, {lr}
	bx lr
	arm_func_end CARDi_TerminateARM7
...
_03804354:
	...
	bx lr
	.align 2, 0
_03804360: .word isCardPullOut
_03804364: .word 0x027FFC40
_03804368: .word nextCount_3193
_0380436C: .word 0x027FFC3C
_03804370: .word isFirstCheck_3202
...
CARD_CompareCardID: // 0x038043A0
	...
	moveq r2, #1
	movne r2, #0
	ldr r1, _03804404 // =detectPullOut
	str r2, [r1]
	add sp, sp, #4
	ldmia sp!, {lr}
	bx lr
...
_038044D0:
	...
	bx lr
	.align 2, 0
_038044DC: .word isInitialized_3152
...
.public nextCount_3193
nextCount_3193: // 0x03808300
	.word 0xFFFFFFFF
	
.public isFirstCheck_3202
isFirstCheck_3202: // 0x03808304
	.word 1