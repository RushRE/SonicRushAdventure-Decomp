...
sub_27EA744: // 0x027EA744
	...
	mov sl, r0
	cmp r1, #0
	ldrne sb, _027EA9BC // =sub_27F59D8
	ldreq sb, _027EA9C0 // =sub_27F5A28
	mov r0, sl
	bl sub_27E9DD0
	cmp r0, #0
	moveq r0, #5
...
sub_27EB58C: // 0x027EB58C
	...
	ldrh r0, [r0, #0xf8]
	cmp r0, #5
	ldreq sl, _027EB87C // =0x027F80C4
	ldrne sl, _027EB880 // =0x027F80F8
	mov r6, #0
	mov r5, #0xff
	mvn r4, #0
	b _027EB5E0
