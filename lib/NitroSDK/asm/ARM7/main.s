...
_037F8528: .word 0x04000208
	...
	arm_func_start _Ven__SVC_Halt
_Ven__SVC_Halt: // 0x037F852C
	ldr ip, _037F8534 // =SVC_Halt
	bx ip
	.align 2, 0
_037F8534: .word SVC_Halt
	arm_func_end _Ven__SVC_Halt
...
_037F94D0:
	mov r0, #0x64
	ldr r1, _037F94F0 // =WIntervalTimer
...
SetParentTbttTxqTask: // 0x037FB1D4
	stmdb sp!, {r4, lr}
...
_037FB388:
	...
	str r0, [r6, #0x30]
	ldr r0, _037FB618 // =TxqEndData
	str r0, [r6, #0x10]
	ldr r0, _037FB61C // =TxqEndManCtrl
	str r0, [r6, #0x24]
	ldr r0, _037FB620 // =TxqEndPsPoll
	str r0, [r6, #0x38]
...
_037FB408:
	...
	ldr r0, _037FB61C // =TxqEndManCtrl
	str r0, [r6, #0x24]
	ldr r0, _037FB654 // =TxqEndBroadCast
	str r0, [r6, #0x38]
...
_037FB618: .word TxqEndData
_037FB61C: .word TxqEndManCtrl
_037FB620: .word TxqEndPsPoll
...
_037FB654: .word TxqEndBroadCast
