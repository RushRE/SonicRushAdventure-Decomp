...
MIC_Func_3806BE0: // 0x03806BE0
	...
	mov r0, #0x9f
	msr cpsr_c, r0
	ldr r1, _03806D50 // =0x03808434
	ldrh r0, [r1, #2]
	add r0, r0, #1
	strh r0, [r1, #2]
	ldr r1, _03806D54 // =0x0380BBB8
	cmp r0, #1
	moveq r0, sp
	ldreq sp, [r1, #4]
	streq r0, [r1, #4]
