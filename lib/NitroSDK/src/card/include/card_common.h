#ifndef _NITRO_CARD_COMMON_H
#define _NITRO_CARD_COMMON_H
...
SDK_INLINE void CARDi_WaitTask(CARDiCommon *p, MIDmaCallback callback, void *callback_arg)
{
...
SDK_INLINE void CARDi_EndTask(CARDiCommon *p, BOOL is_own_task)
{
