        ...
        while (command_p != NULL)
        {
            ...
            switch (command.id)
            {
                case SND_COMMAND_START_SEQ:
                    SND_StartSeq((int)command.arg[0], (const void *)command.arg[1], command.arg[2], (struct SNDBankData *)command.arg[3]);
                    break;
                ...
                case SND_COMMAND_PREPARE_SEQ:
                    SND_PrepareSeq((int)command.arg[0], (const void *)command.arg[1], command.arg[2], (struct SNDBankData *)command.arg[3]);
                    break;
                ...
                case SND_COMMAND_PLAYER_PARAM:
                    SNDi_SetPlayerParam((int)command.arg[0], command.arg[1], command.arg[2], (int)command.arg[3]);
                    break;

                case SND_COMMAND_TRACK_PARAM:
                    SNDi_SetTrackParam((int)UNPACK_COMMAND(command.arg[0], 0, 24), command.arg[1], command.arg[2], command.arg[3], (int)UNPACK_COMMAND(command.arg[0], 24, 8));
                    break;
                ...
                case SND_COMMAND_PLAYER_LOCAL_VAR:
                    SND_SetPlayerLocalVariable((int)command.arg[0], (int)command.arg[1], (s16)command.arg[2]);
                    break;
                ...
                case SND_COMMAND_SETUP_CAPTURE:
                    SND_SetupCapture((SNDCapture)UNPACK_COMMAND(command.arg[2], 31, 1), (SNDCaptureFormat)UNPACK_COMMAND(command.arg[2], 30, 1), (void *)command.arg[0],
                                     (int)command.arg[1], (BOOL)UNPACK_COMMAND(command.arg[2], 29, 1), (SNDCaptureIn)UNPACK_COMMAND(command.arg[2], 28, 1),
                                     (SNDCaptureOut)UNPACK_COMMAND(command.arg[2], 27, 1));
                    break;

                case SND_COMMAND_SETUP_ALARM:
                    SND_SetupAlarm((int)command.arg[0], (OSTick)command.arg[1], (OSTick)command.arg[2], (int)command.arg[3]);
                    break;
                ...
                case SND_COMMAND_CHANNEL_VOLUME:
                    SetChannelVolume((u32)command.arg[0], (int)command.arg[1], (SNDChannelDataShift)command.arg[2]);
                    break;
                ...
                case SND_COMMAND_SETUP_CHANNEL_PCM:
                    SND_SetupChannelPcm((int)UNPACK_COMMAND(command.arg[0], 0, 16), (const void *)UNPACK_COMMAND(command.arg[1], 0, 27),
                                        (SNDWaveFormat)UNPACK_COMMAND(command.arg[3], 24, 2), (SNDChannelLoop)UNPACK_COMMAND(command.arg[3], 26, 2),
                                        (int)UNPACK_COMMAND(command.arg[3], 0, 16), (int)UNPACK_COMMAND(command.arg[2], 0, 22), (int)UNPACK_COMMAND(command.arg[2], 24, 7),
                                        (SNDChannelDataShift)UNPACK_COMMAND(command.arg[2], 22, 2), (int)UNPACK_COMMAND(command.arg[0], 16, 16),
                                        (int)UNPACK_COMMAND(command.arg[3], 16, 7));
                    break;

                case SND_COMMAND_SETUP_CHANNEL_PSG:
                    SND_SetupChannelPsg((int)command.arg[0], (SNDDuty)command.arg[3], (int)UNPACK_COMMAND(command.arg[1], 0, 7),
                                        (SNDChannelDataShift)UNPACK_COMMAND(command.arg[1], 8, 2), (int)UNPACK_COMMAND(command.arg[2], 8, 16),
                                        (int)UNPACK_COMMAND(command.arg[2], 0, 7));
                    break;

                case SND_COMMAND_SETUP_CHANNEL_NOISE:
                    SND_SetupChannelNoise((int)command.arg[0], (int)UNPACK_COMMAND(command.arg[1], 0, 7), (SNDChannelDataShift)UNPACK_COMMAND(command.arg[1], 8, 2),
                                          (int)UNPACK_COMMAND(command.arg[2], 8, 16), (int)UNPACK_COMMAND(command.arg[2], 0, 7));
                    break;
                ...
                case SND_COMMAND_OUTPUT_SELECTOR:
                    SND_SetOutputSelector((SNDOutput)command.arg[0], (SNDOutput)command.arg[1], (SNDChannelOut)command.arg[2], (SNDChannelOut)command.arg[3]);
                    break;
