...
{
    static const u32 sz =
        (sizeof(NNS_G3dGlb.cmd0) + sizeof(NNS_G3dGlb.mtxmode_proj) + sizeof(NNS_G3dGlb.projMtx) + sizeof(NNS_G3dGlb.mtxmode_posvec) + sizeof(NNS_G3dGlb.cameraMtx)
         + sizeof(NNS_G3dGlb.cmd1) + sizeof(NNS_G3dGlb.lightVec[0]) * 4 + sizeof(NNS_G3dGlb.cmd2) + sizeof(NNS_G3dGlb.prmMatColor0) + sizeof(NNS_G3dGlb.prmMatColor1)
         + sizeof(NNS_G3dGlb.prmPolygonAttr) + sizeof(NNS_G3dGlb.prmViewPort) + sizeof(NNS_G3dGlb.cmd4) + sizeof(NNS_G3dGlb.prmBaseTrans) + sizeof(NNS_G3dGlb.prmBaseRot)
         + sizeof(NNS_G3dGlb.prmBaseScale) + sizeof(NNS_G3dGlb.prmTexImageParam) + sizeof(NNS_G3dGlb.cmd3) + sizeof(NNS_G3dGlb.lightColor[0]) * 4)
        / 4;
...
void NNS_G3dGlbFlushVP(void)
{
    static const u32 sz =
        (sizeof(NNS_G3dGlb.cmd1) + sizeof(NNS_G3dGlb.lightVec[0]) * 4 + sizeof(NNS_G3dGlb.cmd2) + sizeof(NNS_G3dGlb.prmMatColor0) + sizeof(NNS_G3dGlb.prmMatColor1)
         + sizeof(NNS_G3dGlb.prmPolygonAttr) + sizeof(NNS_G3dGlb.prmViewPort) + sizeof(NNS_G3dGlb.cmd3) + sizeof(NNS_G3dGlb.lightColor[0]) * 4 + sizeof(NNS_G3dGlb.cmd4)
         + sizeof(NNS_G3dGlb.prmBaseRot) + sizeof(NNS_G3dGlb.prmBaseTrans) + sizeof(NNS_G3dGlb.prmBaseScale) + sizeof(NNS_G3dGlb.prmTexImageParam))
        / 4;

    NNS_G3dGeBufferOP_N(GX_PACK_OP(G3OP_MTX_MODE, G3OP_MTX_LOAD_4x4, G3OP_NOP, G3OP_NOP), (u32 *)&NNS_G3dGlb.mtxmode_proj,
...
void NNS_G3dGlbFlushWVP(void)
{
    static const u32 sz =
        (sizeof(NNS_G3dGlb.cmd1) + sizeof(NNS_G3dGlb.lightVec[0]) * 4 + sizeof(NNS_G3dGlb.cmd2) + sizeof(NNS_G3dGlb.prmMatColor0) + sizeof(NNS_G3dGlb.prmMatColor1)
         + sizeof(NNS_G3dGlb.prmPolygonAttr) + sizeof(NNS_G3dGlb.prmViewPort) + sizeof(NNS_G3dGlb.cmd3) + sizeof(NNS_G3dGlb.lightColor[0]) * 4)
        / 4;
    ...
    NNS_G3dGeBufferOP_N(GX_PACK_OP(G3OP_MTX_MULT_4x3, G3OP_MTX_SCALE, G3OP_NOP, G3OP_NOP), (u32 *)&NNS_G3dGlb.prmBaseRot,
                        (sizeof(NNS_G3dGlb.prmBaseRot) + sizeof(NNS_G3dGlb.prmBaseTrans) + sizeof(NNS_G3dGlb.prmBaseScale)) / 4);
...
void NNS_G3dGlbSetBaseTrans(const VecFx32 *pTrans)
{
    ...
    NNS_G3dGlb.flag &= ~(NNS_G3D_GLB_FLAG_INVBASE_UPTODATE | NNS_G3D_GLB_FLAG_INVBASECAMERA_UPTODATE | NNS_G3D_GLB_FLAG_BASECAMERA_UPTODATE);
}
