...
void NNS_G3dMdlSetMdlDiff(NNSG3dResMdl *pMdl, u32 matID, GXRgb col)
{
    ...
    data->diffAmb =
        (data->diffAmb & ~(REG_G3_DIF_AMB_DIFFUSE_RED_MASK | REG_G3_DIF_AMB_DIFFUSE_GREEN_MASK | REG_G3_DIF_AMB_DIFFUSE_BLUE_MASK)) | (col << REG_G3_DIF_AMB_DIFFUSE_RED_SHIFT);
}
...
void NNS_G3dMdlSetMdlAmb(NNSG3dResMdl *pMdl, u32 matID, GXRgb col)
{
    ...
    data->diffAmb =
        (data->diffAmb & ~(REG_G3_DIF_AMB_AMBIENT_RED_MASK | REG_G3_DIF_AMB_AMBIENT_GREEN_MASK | REG_G3_DIF_AMB_AMBIENT_BLUE_MASK)) | (col << REG_G3_DIF_AMB_AMBIENT_RED_SHIFT);
}
...
void NNS_G3dMdlSetMdlSpec(NNSG3dResMdl *pMdl, u32 matID, GXRgb col)
{
    ...
    data->specEmi =
        (data->specEmi & ~(REG_G3_SPE_EMI_SPECULAR_RED_MASK | REG_G3_SPE_EMI_SPECULAR_GREEN_MASK | REG_G3_SPE_EMI_SPECULAR_BLUE_MASK)) | (col << REG_G3_SPE_EMI_SPECULAR_RED_SHIFT);
}
...
void NNS_G3dMdlSetMdlEmi(NNSG3dResMdl *pMdl, u32 matID, GXRgb col)
{
    ...
    data->specEmi =
        (data->specEmi & ~(REG_G3_SPE_EMI_EMISSION_RED_MASK | REG_G3_SPE_EMI_EMISSION_GREEN_MASK | REG_G3_SPE_EMI_EMISSION_BLUE_MASK)) | (col << REG_G3_SPE_EMI_EMISSION_RED_SHIFT);
}
...
void NNS_G3dMdlSetMdlLightEnableFlag(NNSG3dResMdl *pMdl, u32 matID, int light)
{
    ...
    data->polyAttr = (data->polyAttr & ~REG_G3_POLYGON_ATTR_LE_MASK) | (light << REG_G3_POLYGON_ATTR_LE_SHIFT);
}
...
void NNS_G3dMdlSetMdlPolygonMode(NNSG3dResMdl *pMdl, u32 matID, GXPolygonMode polyMode)
{
    ...
    data->polyAttr = (data->polyAttr & ~REG_G3_POLYGON_ATTR_PM_MASK) | (polyMode << REG_G3_POLYGON_ATTR_PM_SHIFT);
}
...
void NNS_G3dMdlSetMdlCullMode(NNSG3dResMdl *pMdl, u32 matID, GXCull cullMode)
{
    ...
    data->polyAttr = (data->polyAttr & ~(REG_G3_POLYGON_ATTR_BK_MASK | REG_G3_POLYGON_ATTR_FR_MASK)) | (cullMode << REG_G3_POLYGON_ATTR_BK_SHIFT);
}
...
void NNS_G3dMdlSetMdlPolygonID(NNSG3dResMdl *pMdl, u32 matID, int polygonID)
{
    ...
    data->polyAttr = (data->polyAttr & ~REG_G3_POLYGON_ATTR_ID_MASK) | (polygonID << REG_G3_POLYGON_ATTR_ID_SHIFT);
}
...
void NNS_G3dMdlSetMdlAlpha(NNSG3dResMdl *pMdl, u32 matID, int alpha)
{
    ...
    data->polyAttr = (data->polyAttr & ~REG_G3_POLYGON_ATTR_ALPHA_MASK) | (alpha << REG_G3_POLYGON_ATTR_ALPHA_SHIFT);
}
...
GXRgb NNS_G3dMdlGetMdlDiff(const NNSG3dResMdl *pMdl, u32 matID)
{
    ...
    return (GXRgb)((data->diffAmb & (REG_G3_DIF_AMB_DIFFUSE_RED_MASK | REG_G3_DIF_AMB_DIFFUSE_GREEN_MASK | REG_G3_DIF_AMB_DIFFUSE_BLUE_MASK)) >> REG_G3_DIF_AMB_DIFFUSE_RED_SHIFT);
}
...
GXRgb NNS_G3dMdlGetMdlAmb(const NNSG3dResMdl *pMdl, u32 matID)
{
    ...
    return (GXRgb)((data->diffAmb & (REG_G3_DIF_AMB_AMBIENT_RED_MASK | REG_G3_DIF_AMB_AMBIENT_GREEN_MASK | REG_G3_DIF_AMB_AMBIENT_BLUE_MASK)) >> REG_G3_DIF_AMB_AMBIENT_RED_SHIFT);
}
...
int NNS_G3dMdlGetMdlLightEnableFlag(const NNSG3dResMdl *pMdl, u32 matID)
{
    ...
    return (int)((data->polyAttr & REG_G3_POLYGON_ATTR_LE_MASK) >> REG_G3_POLYGON_ATTR_LE_SHIFT);
}
...
GXPolygonMode NNS_G3dMdlGetMdlPolygonMode(const NNSG3dResMdl *pMdl, u32 matID)
{
    ...
    return (GXPolygonMode)((data->polyAttr & REG_G3_POLYGON_ATTR_PM_MASK) >> REG_G3_POLYGON_ATTR_PM_SHIFT);
}
...
GXCull NNS_G3dMdlGetMdlCullMode(const NNSG3dResMdl *pMdl, u32 matID)
{
    ...
    return (GXCull)((data->polyAttr & (REG_G3_POLYGON_ATTR_BK_MASK | REG_G3_POLYGON_ATTR_FR_MASK)) >> REG_G3_POLYGON_ATTR_BK_SHIFT);
}
...
int NNS_G3dMdlGetMdlPolygonID(const NNSG3dResMdl *pMdl, u32 matID)
{
    ...
    return (int)((data->polyAttr & REG_G3_POLYGON_ATTR_ID_MASK) >> REG_G3_POLYGON_ATTR_ID_SHIFT);
}
...
int NNS_G3dMdlGetMdlAlpha(const NNSG3dResMdl *pMdl, u32 matID)
{
    ...
    return (int)((data->polyAttr & REG_G3_POLYGON_ATTR_ALPHA_MASK) >> REG_G3_POLYGON_ATTR_ALPHA_SHIFT);
}
