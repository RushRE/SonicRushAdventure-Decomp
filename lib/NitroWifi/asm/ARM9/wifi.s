...
_020BEE6C:
	...
	addge sp, sp, #0x4c
	mvnge r0, #0
	ldmgeia sp!, {r4, r5, r6, r7, r8, sb, sl, fp, lr}
	bxge lr
	strb r6, [r2], #1
	ldr r3, [sp, #0xc]
	add r3, r3, #1
...
sub_20C35D8: // 0x020C35D8
	...
	mov r6, r0
	bl OS_DisableInterrupts
	ldr sl, _020C36A0 // =0x0214585C
	ldr sb, _020C36A4 // =0x2145854
	ldr r2, [sl]
	ldr r1, [sb]
	mov r5, r0
	cmp r2, r1
