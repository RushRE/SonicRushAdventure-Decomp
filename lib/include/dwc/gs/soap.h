...
void gsiExecuteSoap(GSSoapFunc theFunc, const char *theURL, const char *theService, void *theNamespaces, void *theRequestData, void *theResponseData, GSSoapCallbackFunc theCallbackFunc,
