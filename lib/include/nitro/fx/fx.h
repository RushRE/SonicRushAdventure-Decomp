#ifndef NITRO_FX_FX_H
#define NITRO_FX_FX_H
...
#define FX_F32_TO_FX64(x) ((fx64)(((x) > 0) ? ((x) * (1 << FX32_SHIFT) + 0.5f) : ((x) * (1 << FX32_SHIFT) - 0.5f)))
...
#define FX_F32_TO_FX64C(x) ((fx64c)(((x) > 0) ? ((x) * ((fx64c)1 << FX64C_SHIFT) + 0.5f) : ((x) * ((fx64c)1 << FX64C_SHIFT) - 0.5f)))
...
#define FX_F32_TO_FX16(x) ((fx16)(((x) > 0) ? (fx16)((x) * (1 << FX16_SHIFT) + 0.5f) : (fx16)((x) * (1 << FX16_SHIFT) - 0.5f)))
