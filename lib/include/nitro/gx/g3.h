#ifndef NITRO_GX_G3_H
#define NITRO_GX_G3_H
...
#define GX_VECVTX10(x, y, z)                                                                                                                                                                           \
    ((VecVtx10)(((((x) >> (FX32_DEC_SIZE - GX_VTX10_DEC_SIZE)) & GX_VTX10_MASK) << GX_VEC_VTX10_X_SHIFT) | ((((y) >> (FX32_DEC_SIZE - GX_VTX10_DEC_SIZE)) & GX_VTX10_MASK) << GX_VEC_VTX10_Y_SHIFT)    \
...
#define GX_VECVTXDIFF(x, y, z) ((VecVtxDiff)((((x)&GX_VTXDIFF_MASK) << GX_VEC_VTXDIFF_X_SHIFT) | (((y)&GX_VTXDIFF_MASK) << GX_VEC_VTXDIFF_Y_SHIFT) | (((z)&GX_VTXDIFF_MASK) << GX_VEC_VTXDIFF_Z_SHIFT)))

#define GX_FX16ST(x) ((s16)((x) >> 8))
#define GX_ST(s, t)  ((GXSt)((u16)GX_FX16ST(s) | ((u16)GX_FX16ST(t) << 16)))

#define GX_COMP4x4_PLTT_IDX(image) ((u32)(0x20000 + (((image)&0x1ffff) >> 1) + (((image)&0x40000) >> 2)))

#define GX_PACK_OP(op1, op2, op3, op4)                         ((u32)((op1) | ((op2) << 8) | ((op3) << 16) | ((op4) << 24)))
...
#define GX_PACK_LIGHTVECTOR_PARAM(lightID, x, y, z)            ((u32)GX_VECFX10((x), (y), (z)) | ((u32)(lightID) << REG_G3_LIGHT_VECTOR_LNUM_SHIFT))
#define GX_PACK_LIGHTCOLOR_PARAM(lightID, rgb)                 ((u32)((rgb) | ((u32)(lightID) << REG_G3_LIGHT_COLOR_LNUM_SHIFT)))
...
#define GX_PACK_POLYGONATTR_PARAM(light, polyMode, cullMode, polygonID, alpha, misc)                                                                                                                   \
    ((u32)(((light) << REG_G3_POLYGON_ATTR_LE_SHIFT) | ((polyMode) << REG_G3_POLYGON_ATTR_PM_SHIFT) | ((cullMode) << REG_G3_POLYGON_ATTR_BK_SHIFT) | (misc)                                            \
           | ((polygonID) << REG_G3_POLYGON_ATTR_ID_SHIFT) | ((alpha) << REG_G3_POLYGON_ATTR_ALPHA_SHIFT)))
#define GX_PACK_BEGIN_PARAM(primitive) ((u32)((primitive) << REG_G3_BEGIN_VTXS_TYPE_SHIFT))
...
#define GX_PACK_TEXIMAGE_PARAM(texFmt, texGen, s, t, repeat, flip, pltt0, addr)                                                                                                                        \
    ((u32)(((addr) >> 3) | ((texFmt) << REG_G3_TEXIMAGE_PARAM_TEXFMT_SHIFT) | ((texGen) << REG_G3_TEXIMAGE_PARAM_TGEN_SHIFT) | ((s) << REG_G3_TEXIMAGE_PARAM_V_SIZE_SHIFT)                             \
           | ((t) << REG_G3_TEXIMAGE_PARAM_T_SIZE_SHIFT) | ((repeat) << REG_G3_TEXIMAGE_PARAM_RS_SHIFT) | ((flip) << REG_G3_TEXIMAGE_PARAM_FS_SHIFT) | ((pltt0) << REG_G3_TEXIMAGE_PARAM_TR_SHIFT)))
