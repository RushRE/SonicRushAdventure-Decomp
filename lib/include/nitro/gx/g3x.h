...
#define GX_LISTRAM_COUNT_MAX 0x800
#define GX_VTXRAM_COUNT_MAX  0x1800
...
static inline void G3X_AlphaTest(BOOL enable, int ref)
{
    if (enable)
    {
        reg_G3X_DISP3DCNT      = (u16)(reg_G3X_DISP3DCNT & ~(REG_G3X_DISP3DCNT_RO_MASK | REG_G3X_DISP3DCNT_GO_MASK) | REG_G3X_DISP3DCNT_ATE_MASK);
        reg_G3X_ALPHA_TEST_REF = (u16)ref;
    }
    else
    {
        reg_G3X_DISP3DCNT &= (u16) ~(REG_G3X_DISP3DCNT_ATE_MASK | REG_G3X_DISP3DCNT_RO_MASK | REG_G3X_DISP3DCNT_GO_MASK);
    }
}
...
static inline void G3X_AlphaBlend(BOOL enable)
{
    if (enable)
    {
        reg_G3X_DISP3DCNT = (u16)(reg_G3X_DISP3DCNT & ~(REG_G3X_DISP3DCNT_RO_MASK | REG_G3X_DISP3DCNT_GO_MASK) | REG_G3X_DISP3DCNT_ABE_MASK);
    }
    else
    {
        reg_G3X_DISP3DCNT &= (u16) ~(REG_G3X_DISP3DCNT_ABE_MASK | REG_G3X_DISP3DCNT_RO_MASK | REG_G3X_DISP3DCNT_GO_MASK);
    }
}
...
static inline void G3X_AntiAlias(BOOL enable)
{
    if (enable)
    {
        reg_G3X_DISP3DCNT = (u16)(reg_G3X_DISP3DCNT & ~(REG_G3X_DISP3DCNT_RO_MASK | REG_G3X_DISP3DCNT_GO_MASK) | REG_G3X_DISP3DCNT_AAE_MASK);
    }
    else
    {
        reg_G3X_DISP3DCNT &= (u16) ~(REG_G3X_DISP3DCNT_AAE_MASK | REG_G3X_DISP3DCNT_RO_MASK | REG_G3X_DISP3DCNT_GO_MASK);
    }
}
...
static inline void G3X_EdgeMarking(BOOL enable)
{
    if (enable)
    {
        reg_G3X_DISP3DCNT = (u16)(reg_G3X_DISP3DCNT & ~(REG_G3X_DISP3DCNT_RO_MASK | REG_G3X_DISP3DCNT_GO_MASK) | REG_G3X_DISP3DCNT_EME_MASK);
    }
    else
    {
        reg_G3X_DISP3DCNT &= (u16) ~(REG_G3X_DISP3DCNT_EME_MASK | REG_G3X_DISP3DCNT_RO_MASK | REG_G3X_DISP3DCNT_GO_MASK);
    }
}

static inline void G3X_SetFifoIntrCond(GXFifoIntrCond cond)
{
    reg_G3X_GXSTAT = ((reg_G3X_GXSTAT & ~REG_G3X_GXSTAT_FI_MASK) | (cond << REG_G3X_GXSTAT_FI_SHIFT));
}

static inline void G3X_SetClearImageOffset(int xOffset, int yOffset)
{
    reg_G3X_CLRIMAGE_OFFSET = (u16)(((xOffset << REG_G3X_CLRIMAGE_OFFSET_OFFSETX_SHIFT) & REG_G3X_CLRIMAGE_OFFSET_OFFSETX_MASK)
                                    | ((yOffset << REG_G3X_CLRIMAGE_OFFSET_OFFSETY_SHIFT) & REG_G3X_CLRIMAGE_OFFSET_OFFSETY_MASK));
}

static inline void G3X_SetFogColor(GXRgb rgb, int alpha)
{
    reg_G3X_FOG_COLOR = (u32)((rgb << REG_G3X_FOG_COLOR_FOG_RED_SHIFT) | (alpha << REG_G3X_FOG_COLOR_FOG_ALPHA_SHIFT));
}
...
{
    return (GXFifoStat)((reg_G3X_GXSTAT & (REG_G3X_GXSTAT_F_MASK | REG_G3X_GXSTAT_H_MASK | REG_G3X_GXSTAT_E_MASK)) >> REG_G3X_GXSTAT_F_SHIFT);
}
