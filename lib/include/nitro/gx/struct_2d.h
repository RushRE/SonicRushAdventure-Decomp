#ifndef NITRO_STRUCT_2D_H
#define NITRO_STRUCT_2D_H
...
#define GX_SCRFMT_TEXT(pltt, vf, hf, name)                                                                                                                                         \
    ((u16)(((name) << GX_SCRFMT_TEXT_CHARNAME_SHIFT) | ((hf) << GX_SCRFMT_TEXT_HF_SHIFT) | ((vf) << GX_SCRFMT_TEXT_VF_SHIFT) | ((pltt) << GX_SCRFMT_TEXT_COLORPLTT_SHIFT)))
