...
#define REG_MI_DMA0CNT_FIELD(e, i, timing, sb, cm, sar, dar, wordcnt)                                                                                                                                  \
    (u32)(((u32)(e) << REG_MI_DMA0CNT_E_SHIFT) | ((u32)(i) << REG_MI_DMA0CNT_I_SHIFT) | ((u32)(timing) << REG_MI_DMA0CNT_TIMING_SHIFT) | ((u32)(sb) << REG_MI_DMA0CNT_SB_SHIFT)                        \
...
#define REG_MI_DMA1CNT_FIELD(e, i, timing, sb, cm, sar, dar, wordcnt)                                                                                                                                  \
    (u32)(((u32)(e) << REG_MI_DMA1CNT_E_SHIFT) | ((u32)(i) << REG_MI_DMA1CNT_I_SHIFT) | ((u32)(timing) << REG_MI_DMA1CNT_TIMING_SHIFT) | ((u32)(sb) << REG_MI_DMA1CNT_SB_SHIFT)                        \
...
#define REG_MI_DMA2CNT_FIELD(e, i, timing, sb, cm, sar, dar, wordcnt)                                                                                                                                  \
    (u32)(((u32)(e) << REG_MI_DMA2CNT_E_SHIFT) | ((u32)(i) << REG_MI_DMA2CNT_I_SHIFT) | ((u32)(timing) << REG_MI_DMA2CNT_TIMING_SHIFT) | ((u32)(sb) << REG_MI_DMA2CNT_SB_SHIFT)                        \
...
#define REG_MI_DMA3CNT_FIELD(e, i, timing, sb, cm, sar, dar, wordcnt)                                                                                                                                  \
    (u32)(((u32)(e) << REG_MI_DMA3CNT_E_SHIFT) | ((u32)(i) << REG_MI_DMA3CNT_I_SHIFT) | ((u32)(timing) << REG_MI_DMA3CNT_TIMING_SHIFT) | ((u32)(sb) << REG_MI_DMA3CNT_SB_SHIFT)                        \
...
#define REG_MI_EXMEMCNT_L_FIELD(ep, mp, cp, phi, rom2nd, rom1st, ram)                                                                                                                                  \
    (u16)(((u32)(ep) << REG_MI_EXMEMCNT_L_EP_SHIFT) | ((u32)(mp) << REG_MI_EXMEMCNT_L_MP_SHIFT) | ((u32)(cp) << REG_MI_EXMEMCNT_L_CP_SHIFT) | ((u32)(phi) << REG_MI_EXMEMCNT_L_PHI_SHIFT)              \
          | ((u32)(rom2nd) << REG_MI_EXMEMCNT_L_ROM2nd_SHIFT) | ((u32)(rom1st) << REG_MI_EXMEMCNT_L_ROM1st_SHIFT) | ((u32)(ram) << REG_MI_EXMEMCNT_L_RAM_SHIFT))
#endif
...
#define REG_MI_EXMEMCNT_H_FIELD(phi33m, ww1_2nd, ww1_1st, ww0_2nd, ww0_1st)                                                                                                                            \
    (u16)(((u32)(phi33m) << REG_MI_EXMEMCNT_H_PHI33M_SHIFT) | ((u32)(ww1_2nd) << REG_MI_EXMEMCNT_H_WW1_2nd_SHIFT) | ((u32)(ww1_1st) << REG_MI_EXMEMCNT_H_WW1_1st_SHIFT)                                \
          | ((u32)(ww0_2nd) << REG_MI_EXMEMCNT_H_WW0_2nd_SHIFT) | ((u32)(ww0_1st) << REG_MI_EXMEMCNT_H_WW0_1st_SHIFT))
#endif
...
#define REG_MI_WVRAMSTAT_FIELD(wram_1, wram_0, vram_d, vram_c)                                                                                                                                         \
    (u16)(((u32)(wram_1) << REG_MI_WVRAMSTAT_WRAM_1_SHIFT) | ((u32)(wram_0) << REG_MI_WVRAMSTAT_WRAM_0_SHIFT) | ((u32)(vram_d) << REG_MI_WVRAMSTAT_VRAM_D_SHIFT)                                       \
