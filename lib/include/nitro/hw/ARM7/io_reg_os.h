...
#ifndef SDK_ASM
#define REG_OS_TM0CNT_L_FIELD(timer0cnt) (u16)(((u32)(timer0cnt) << REG_OS_TM0CNT_L_TIMER0CNT_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_OS_TM0CNT_H_FIELD(e, i, ps) (u16)(((u32)(e) << REG_OS_TM0CNT_H_E_SHIFT) | ((u32)(i) << REG_OS_TM0CNT_H_I_SHIFT) | ((u32)(ps) << REG_OS_TM0CNT_H_PS_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_OS_TM1CNT_L_FIELD(timer1cnt) (u16)(((u32)(timer1cnt) << REG_OS_TM1CNT_L_TIMER1CNT_SHIFT))
#endif
...
#define REG_OS_TM1CNT_H_FIELD(e, i, ch, ps)                                                                                                                                                            \
    (u16)(((u32)(e) << REG_OS_TM1CNT_H_E_SHIFT) | ((u32)(i) << REG_OS_TM1CNT_H_I_SHIFT) | ((u32)(ch) << REG_OS_TM1CNT_H_CH_SHIFT) | ((u32)(ps) << REG_OS_TM1CNT_H_PS_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_OS_TM2CNT_L_FIELD(timer2cnt) (u16)(((u32)(timer2cnt) << REG_OS_TM2CNT_L_TIMER2CNT_SHIFT))
#endif
...
#define REG_OS_TM2CNT_H_FIELD(e, i, ch, ps)                                                                                                                                                            \
    (u16)(((u32)(e) << REG_OS_TM2CNT_H_E_SHIFT) | ((u32)(i) << REG_OS_TM2CNT_H_I_SHIFT) | ((u32)(ch) << REG_OS_TM2CNT_H_CH_SHIFT) | ((u32)(ps) << REG_OS_TM2CNT_H_PS_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_OS_TM3CNT_L_FIELD(timer2cnt) (u16)(((u32)(timer2cnt) << REG_OS_TM3CNT_L_TIMER2CNT_SHIFT))
#endif
...
#define REG_OS_TM3CNT_H_FIELD(e, i, ch, ps)                                                                                                                                                            \
    (u16)(((u32)(e) << REG_OS_TM3CNT_H_E_SHIFT) | ((u32)(i) << REG_OS_TM3CNT_H_I_SHIFT) | ((u32)(ch) << REG_OS_TM3CNT_H_CH_SHIFT) | ((u32)(ps) << REG_OS_TM3CNT_H_PS_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_OS_IME_FIELD(ime) (u16)(((u32)(ime) << REG_OS_IME_IME_SHIFT))
#endif
...
#define REG_OS_IE_FIELD(wl, spi, pm, mi, mc, ifn, ife, a7, i_d, k, d3, d2, d1, d0, t3, t2, t1, t0, ve, hb, vb)                                                                                         \
    (u32)(((u32)(wl) << REG_OS_IE_WL_SHIFT) | ((u32)(spi) << REG_OS_IE_SPI_SHIFT) | ((u32)(pm) << REG_OS_IE_PM_SHIFT) | ((u32)(mi) << REG_OS_IE_MI_SHIFT) | ((u32)(mc) << REG_OS_IE_MC_SHIFT)          \
          | ((u32)(ifn) << REG_OS_IE_IFN_SHIFT) | ((u32)(ife) << REG_OS_IE_IFE_SHIFT) | ((u32)(a7) << REG_OS_IE_A7_SHIFT) | ((u32)(i_d) << REG_OS_IE_I_D_SHIFT) | ((u32)(k) << REG_OS_IE_K_SHIFT)      \
          | ((u32)(d3) << REG_OS_IE_D3_SHIFT) | ((u32)(d2) << REG_OS_IE_D2_SHIFT) | ((u32)(d1) << REG_OS_IE_D1_SHIFT) | ((u32)(d0) << REG_OS_IE_D0_SHIFT) | ((u32)(t3) << REG_OS_IE_T3_SHIFT)          \
          | ((u32)(t2) << REG_OS_IE_T2_SHIFT) | ((u32)(t1) << REG_OS_IE_T1_SHIFT) | ((u32)(t0) << REG_OS_IE_T0_SHIFT) | ((u32)(ve) << REG_OS_IE_VE_SHIFT) | ((u32)(hb) << REG_OS_IE_HB_SHIFT)          \
...
#define REG_OS_IF_FIELD(wl, spi, pm, mi, mc, ifn, ife, a7, i_d, k, d3, d2, d1, d0, t3, t2, t1, t0, ve, hb, vb)                                                                                         \
    (u32)(((u32)(wl) << REG_OS_IF_WL_SHIFT) | ((u32)(spi) << REG_OS_IF_SPI_SHIFT) | ((u32)(pm) << REG_OS_IF_PM_SHIFT) | ((u32)(mi) << REG_OS_IF_MI_SHIFT) | ((u32)(mc) << REG_OS_IF_MC_SHIFT)          \
          | ((u32)(ifn) << REG_OS_IF_IFN_SHIFT) | ((u32)(ife) << REG_OS_IF_IFE_SHIFT) | ((u32)(a7) << REG_OS_IF_A7_SHIFT) | ((u32)(i_d) << REG_OS_IF_I_D_SHIFT) | ((u32)(k) << REG_OS_IF_K_SHIFT)      \
          | ((u32)(d3) << REG_OS_IF_D3_SHIFT) | ((u32)(d2) << REG_OS_IF_D2_SHIFT) | ((u32)(d1) << REG_OS_IF_D1_SHIFT) | ((u32)(d0) << REG_OS_IF_D0_SHIFT) | ((u32)(t3) << REG_OS_IF_T3_SHIFT)          \
          | ((u32)(t2) << REG_OS_IF_T2_SHIFT) | ((u32)(t1) << REG_OS_IF_T1_SHIFT) | ((u32)(t0) << REG_OS_IF_T0_SHIFT) | ((u32)(ve) << REG_OS_IF_VE_SHIFT) | ((u32)(hb) << REG_OS_IF_HB_SHIFT)          \
...
#ifndef SDK_ASM
#define REG_OS_PAUSE_FIELD(mod, chk) (u16)(((u32)(mod) << REG_OS_PAUSE_MOD_SHIFT) | ((u32)(chk) << REG_OS_PAUSE_CHK_SHIFT))
#endif