...
#ifndef SDK_ASM
#define REG_SND_POWCNT_FIELD(ewl, spe) (u16)(((u32)(ewl) << REG_SND_POWCNT_EWL_SHIFT) | ((u32)(spe) << REG_SND_POWCNT_SPE_SHIFT))
#endif
...
#define REG_SND_SOUND0CNT_FIELD(e, format, repeat, duty, pan, hold, shift, volume)                                                                                                                     \
    (u32)(((u32)(e) << REG_SND_SOUND0CNT_E_SHIFT) | ((u32)(format) << REG_SND_SOUND0CNT_FORMAT_SHIFT) | ((u32)(repeat) << REG_SND_SOUND0CNT_REPEAT_SHIFT)                                              \
          | ((u32)(duty) << REG_SND_SOUND0CNT_DUTY_SHIFT) | ((u32)(pan) << REG_SND_SOUND0CNT_PAN_SHIFT) | ((u32)(hold) << REG_SND_SOUND0CNT_HOLD_SHIFT)                                                \
          | ((u32)(shift) << REG_SND_SOUND0CNT_SHIFT_SHIFT) | ((u32)(volume) << REG_SND_SOUND0CNT_VOLUME_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_SND_SOUND0CNT_VOL_FIELD(volume) (u8)(((u32)(volume) << REG_SND_SOUND0CNT_VOL_VOLUME_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_SND_SOUND0CNT_PAN_FIELD(pan) (u8)(((u32)(pan) << REG_SND_SOUND0CNT_PAN_PAN_SHIFT))
#endif
...
#define REG_SND_SOUND0CNT_8_FIELD(e, format, repeat, duty)                                                                                                                                             \
    (u8)(((u32)(e) << REG_SND_SOUND0CNT_8_E_SHIFT) | ((u32)(format) << REG_SND_SOUND0CNT_8_FORMAT_SHIFT) | ((u32)(repeat) << REG_SND_SOUND0CNT_8_REPEAT_SHIFT)                                         \
...
#ifndef SDK_ASM
#define REG_SND_SOUND0SAD_FIELD(src) (u32)(((u32)(src) << REG_SND_SOUND0SAD_SRC_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_SND_SOUND0TMR_FIELD(timer) (u16)(((u32)(timer) << REG_SND_SOUND0TMR_TIMER_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_SND_SOUND0RPT_PT_FIELD(point) (u16)(((u32)(point) << REG_SND_SOUND0RPT_PT_POINT_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_SND_SOUND0RPT_LEN_FIELD(len) (u32)(((u32)(len) << REG_SND_SOUND0RPT_LEN_LEN_SHIFT))
#endif
...
#define REG_SND_SOUNDCNT_FIELD(e, mix_ch3, mix_ch1, rout, lout, volume)                                                                                                                                \
    (u16)(((u32)(e) << REG_SND_SOUNDCNT_E_SHIFT) | ((u32)(mix_ch3) << REG_SND_SOUNDCNT_MIX_CH3_SHIFT) | ((u32)(mix_ch1) << REG_SND_SOUNDCNT_MIX_CH1_SHIFT)                                             \
          | ((u32)(rout) << REG_SND_SOUNDCNT_ROUT_SHIFT) | ((u32)(lout) << REG_SND_SOUNDCNT_LOUT_SHIFT) | ((u32)(volume) << REG_SND_SOUNDCNT_VOLUME_SHIFT))
#endif
...
#define REG_SND_SOUNDCNT_8_FIELD(e, mix_ch3, mix_ch1, rout, lout)                                                                                                                                      \
    (u8)(((u32)(e) << REG_SND_SOUNDCNT_8_E_SHIFT) | ((u32)(mix_ch3) << REG_SND_SOUNDCNT_8_MIX_CH3_SHIFT) | ((u32)(mix_ch1) << REG_SND_SOUNDCNT_8_MIX_CH1_SHIFT)                                        \
         | ((u32)(rout) << REG_SND_SOUNDCNT_8_ROUT_SHIFT) | ((u32)(lout) << REG_SND_SOUNDCNT_8_LOUT_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_SND_SOUNDCNT_VOL_FIELD(volume) (u8)(((u32)(volume) << REG_SND_SOUNDCNT_VOL_VOLUME_SHIFT))
#endif
...
#define REG_SND_SNDCAPCNT_FIELD(cap1_e, cap1_format, cap1_repeat, cap1_in, cap1_out, cap0_e, cap0_format, cap0_repeat, cap0_in, cap0_out)                                                              \
    (u16)(((u32)(cap1_e) << REG_SND_SNDCAPCNT_CAP1_E_SHIFT) | ((u32)(cap1_format) << REG_SND_SNDCAPCNT_CAP1_FORMAT_SHIFT) | ((u32)(cap1_repeat) << REG_SND_SNDCAPCNT_CAP1_REPEAT_SHIFT)                \
          | ((u32)(cap1_in) << REG_SND_SNDCAPCNT_CAP1_IN_SHIFT) | ((u32)(cap1_out) << REG_SND_SNDCAPCNT_CAP1_OUT_SHIFT) | ((u32)(cap0_e) << REG_SND_SNDCAPCNT_CAP0_E_SHIFT)                            \
          | ((u32)(cap0_format) << REG_SND_SNDCAPCNT_CAP0_FORMAT_SHIFT) | ((u32)(cap0_repeat) << REG_SND_SNDCAPCNT_CAP0_REPEAT_SHIFT) | ((u32)(cap0_in) << REG_SND_SNDCAPCNT_CAP0_IN_SHIFT)            \
...
#define REG_SND_SNDCAP0CNT_FIELD(e, format, repeat, in, out)                                                                                                                                           \
    (u8)(((u32)(e) << REG_SND_SNDCAP0CNT_E_SHIFT) | ((u32)(format) << REG_SND_SNDCAP0CNT_FORMAT_SHIFT) | ((u32)(repeat) << REG_SND_SNDCAP0CNT_REPEAT_SHIFT)                                            \
         | ((u32)(in) << REG_SND_SNDCAP0CNT_IN_SHIFT) | ((u32)(out) << REG_SND_SNDCAP0CNT_OUT_SHIFT))
#endif
...
#define REG_SND_SNDCAP1CNT_FIELD(e, format, repeat, in, out)                                                                                                                                           \
    (u8)(((u32)(e) << REG_SND_SNDCAP1CNT_E_SHIFT) | ((u32)(format) << REG_SND_SNDCAP1CNT_FORMAT_SHIFT) | ((u32)(repeat) << REG_SND_SNDCAP1CNT_REPEAT_SHIFT)                                            \
         | ((u32)(in) << REG_SND_SNDCAP1CNT_IN_SHIFT) | ((u32)(out) << REG_SND_SNDCAP1CNT_OUT_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_SND_SNDCAP0DAD_FIELD(dest) (u32)(((u32)(dest) << REG_SND_SNDCAP0DAD_DEST_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_SND_SNDCAP0LEN_FIELD(len) (u16)(((u32)(len) << REG_SND_SNDCAP0LEN_LEN_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_SND_SNDCAP1DAD_FIELD(dest) (u32)(((u32)(dest) << REG_SND_SNDCAP1DAD_DEST_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_SND_SNDCAP1LEN_FIELD(len) (u16)(((u32)(len) << REG_SND_SNDCAP1LEN_LEN_SHIFT))
#endif
