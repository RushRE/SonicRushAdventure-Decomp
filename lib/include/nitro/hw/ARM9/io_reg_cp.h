...
#ifndef SDK_ASM
#define REG_CP_DIVCNT_FIELD(busy, div0, mode) (u16)(((u32)(busy) << REG_CP_DIVCNT_BUSY_SHIFT) | ((u32)(div0) << REG_CP_DIVCNT_DIV0_SHIFT) | ((u32)(mode) << REG_CP_DIVCNT_MODE_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_CP_SQRTCNT_FIELD(busy, mode) (u16)(((u32)(busy) << REG_CP_SQRTCNT_BUSY_SHIFT) | ((u32)(mode) << REG_CP_SQRTCNT_MODE_SHIFT))
#endif