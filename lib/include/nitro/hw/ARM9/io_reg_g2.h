...
#define REG_G2_BG0CNT_FIELD(screensize, bgplttslot, screenbase, colormode, mosaic, charbase, priority)                                                                                                 \
    (u16)(((u32)(screensize) << REG_G2_BG0CNT_SCREENSIZE_SHIFT) | ((u32)(bgplttslot) << REG_G2_BG0CNT_BGPLTTSLOT_SHIFT) | ((u32)(screenbase) << REG_G2_BG0CNT_SCREENBASE_SHIFT)                        \
          | ((u32)(colormode) << REG_G2_BG0CNT_COLORMODE_SHIFT) | ((u32)(mosaic) << REG_G2_BG0CNT_MOSAIC_SHIFT) | ((u32)(charbase) << REG_G2_BG0CNT_CHARBASE_SHIFT)                                    \
...
#define REG_G2_BG1CNT_FIELD(screensize, bgplttslot, screenbase, colormode, mosaic, charbase, priority)                                                                                                 \
    (u16)(((u32)(screensize) << REG_G2_BG1CNT_SCREENSIZE_SHIFT) | ((u32)(bgplttslot) << REG_G2_BG1CNT_BGPLTTSLOT_SHIFT) | ((u32)(screenbase) << REG_G2_BG1CNT_SCREENBASE_SHIFT)                        \
          | ((u32)(colormode) << REG_G2_BG1CNT_COLORMODE_SHIFT) | ((u32)(mosaic) << REG_G2_BG1CNT_MOSAIC_SHIFT) | ((u32)(charbase) << REG_G2_BG1CNT_CHARBASE_SHIFT)                                    \
...
#define REG_G2_BG2CNT_FIELD(screensize, areaover, screenbase, colormode, mosaic, charbase, priority)                                                                                                   \
    (u16)(((u32)(screensize) << REG_G2_BG2CNT_SCREENSIZE_SHIFT) | ((u32)(areaover) << REG_G2_BG2CNT_AREAOVER_SHIFT) | ((u32)(screenbase) << REG_G2_BG2CNT_SCREENBASE_SHIFT)                            \
          | ((u32)(colormode) << REG_G2_BG2CNT_COLORMODE_SHIFT) | ((u32)(mosaic) << REG_G2_BG2CNT_MOSAIC_SHIFT) | ((u32)(charbase) << REG_G2_BG2CNT_CHARBASE_SHIFT)                                    \
...
#define REG_G2_BG3CNT_FIELD(screensize, areaover, screenbase, colormode, mosaic, charbase, priority)                                                                                                   \
    (u16)(((u32)(screensize) << REG_G2_BG3CNT_SCREENSIZE_SHIFT) | ((u32)(areaover) << REG_G2_BG3CNT_AREAOVER_SHIFT) | ((u32)(screenbase) << REG_G2_BG3CNT_SCREENBASE_SHIFT)                            \
          | ((u32)(colormode) << REG_G2_BG3CNT_COLORMODE_SHIFT) | ((u32)(mosaic) << REG_G2_BG3CNT_MOSAIC_SHIFT) | ((u32)(charbase) << REG_G2_BG3CNT_CHARBASE_SHIFT)                                    \
...
#ifndef SDK_ASM
#define REG_G2_BG0OFS_FIELD(voffset, hoffset) (u32)(((u32)(voffset) << REG_G2_BG0OFS_VOFFSET_SHIFT) | ((u32)(hoffset) << REG_G2_BG0OFS_HOFFSET_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_G2_BG0HOFS_FIELD(offset) (u16)(((u32)(offset) << REG_G2_BG0HOFS_OFFSET_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_G2_BG0VOFS_FIELD(offset) (u16)(((u32)(offset) << REG_G2_BG0VOFS_OFFSET_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_G2_BG1OFS_FIELD(voffset, hoffset) (u32)(((u32)(voffset) << REG_G2_BG1OFS_VOFFSET_SHIFT) | ((u32)(hoffset) << REG_G2_BG1OFS_HOFFSET_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_G2_BG1HOFS_FIELD(offset) (u16)(((u32)(offset) << REG_G2_BG1HOFS_OFFSET_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_G2_BG1VOFS_FIELD(offset) (u16)(((u32)(offset) << REG_G2_BG1VOFS_OFFSET_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_G2_BG2OFS_FIELD(voffset, hoffset) (u32)(((u32)(voffset) << REG_G2_BG2OFS_VOFFSET_SHIFT) | ((u32)(hoffset) << REG_G2_BG2OFS_HOFFSET_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_G2_BG2HOFS_FIELD(offset) (u16)(((u32)(offset) << REG_G2_BG2HOFS_OFFSET_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_G2_BG2VOFS_FIELD(offset) (u16)(((u32)(offset) << REG_G2_BG2VOFS_OFFSET_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_G2_BG3OFS_FIELD(voffset, hoffset) (u32)(((u32)(voffset) << REG_G2_BG3OFS_VOFFSET_SHIFT) | ((u32)(hoffset) << REG_G2_BG3OFS_HOFFSET_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_G2_BG3HOFS_FIELD(offset) (u16)(((u32)(offset) << REG_G2_BG3HOFS_OFFSET_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_G2_BG3VOFS_FIELD(offset) (u16)(((u32)(offset) << REG_G2_BG3VOFS_OFFSET_SHIFT))
#endif
...
#define REG_G2_BG2PA_FIELD(s, integer_dx, decimal_dx)                                                                                                                                                  \
    (u16)(((u32)(s) << REG_G2_BG2PA_S_SHIFT) | ((u32)(integer_dx) << REG_G2_BG2PA_INTEGER_DX_SHIFT) | ((u32)(decimal_dx) << REG_G2_BG2PA_DECIMAL_DX_SHIFT))
#endif
...
#define REG_G2_BG2PB_FIELD(s, integer_dmx, decimal_dmx)                                                                                                                                                \
    (u16)(((u32)(s) << REG_G2_BG2PB_S_SHIFT) | ((u32)(integer_dmx) << REG_G2_BG2PB_INTEGER_DMX_SHIFT) | ((u32)(decimal_dmx) << REG_G2_BG2PB_DECIMAL_DMX_SHIFT))
#endif
...
#define REG_G2_BG2PC_FIELD(s, integer_dy, decimal_dy)                                                                                                                                                  \
    (u16)(((u32)(s) << REG_G2_BG2PC_S_SHIFT) | ((u32)(integer_dy) << REG_G2_BG2PC_INTEGER_DY_SHIFT) | ((u32)(decimal_dy) << REG_G2_BG2PC_DECIMAL_DY_SHIFT))
#endif
...
#define REG_G2_BG2PD_FIELD(s, integer_dmy, decimal_dmy)                                                                                                                                                \
    (u16)(((u32)(s) << REG_G2_BG2PD_S_SHIFT) | ((u32)(integer_dmy) << REG_G2_BG2PD_INTEGER_DMY_SHIFT) | ((u32)(decimal_dmy) << REG_G2_BG2PD_DECIMAL_DMY_SHIFT))
#endif
...
#define REG_G2_BG2X_FIELD(s, integer_sx, decimal_sx)                                                                                                                                                   \
    (u32)(((u32)(s) << REG_G2_BG2X_S_SHIFT) | ((u32)(integer_sx) << REG_G2_BG2X_INTEGER_SX_SHIFT) | ((u32)(decimal_sx) << REG_G2_BG2X_DECIMAL_SX_SHIFT))
#endif
...
#define REG_G2_BG2Y_FIELD(s, integer_sy, decimal_sy)                                                                                                                                                   \
    (u32)(((u32)(s) << REG_G2_BG2Y_S_SHIFT) | ((u32)(integer_sy) << REG_G2_BG2Y_INTEGER_SY_SHIFT) | ((u32)(decimal_sy) << REG_G2_BG2Y_DECIMAL_SY_SHIFT))
#endif
...
#define REG_G2_BG3PA_FIELD(s, integer_dx, decimal_dx)                                                                                                                                                  \
    (u16)(((u32)(s) << REG_G2_BG3PA_S_SHIFT) | ((u32)(integer_dx) << REG_G2_BG3PA_INTEGER_DX_SHIFT) | ((u32)(decimal_dx) << REG_G2_BG3PA_DECIMAL_DX_SHIFT))
#endif
...
#define REG_G2_BG3PB_FIELD(s, integer_dmx, decimal_dmx)                                                                                                                                                \
    (u16)(((u32)(s) << REG_G2_BG3PB_S_SHIFT) | ((u32)(integer_dmx) << REG_G2_BG3PB_INTEGER_DMX_SHIFT) | ((u32)(decimal_dmx) << REG_G2_BG3PB_DECIMAL_DMX_SHIFT))
#endif
...
#define REG_G2_BG3PC_FIELD(s, integer_dy, decimal_dy)                                                                                                                                                  \
    (u16)(((u32)(s) << REG_G2_BG3PC_S_SHIFT) | ((u32)(integer_dy) << REG_G2_BG3PC_INTEGER_DY_SHIFT) | ((u32)(decimal_dy) << REG_G2_BG3PC_DECIMAL_DY_SHIFT))
#endif
...
#define REG_G2_BG3PD_FIELD(s, integer_dmy, decimal_dmy)                                                                                                                                                \
    (u16)(((u32)(s) << REG_G2_BG3PD_S_SHIFT) | ((u32)(integer_dmy) << REG_G2_BG3PD_INTEGER_DMY_SHIFT) | ((u32)(decimal_dmy) << REG_G2_BG3PD_DECIMAL_DMY_SHIFT))
#endif
...
#define REG_G2_BG3X_FIELD(s, integer_sx, decimal_sx)                                                                                                                                                   \
    (u32)(((u32)(s) << REG_G2_BG3X_S_SHIFT) | ((u32)(integer_sx) << REG_G2_BG3X_INTEGER_SX_SHIFT) | ((u32)(decimal_sx) << REG_G2_BG3X_DECIMAL_SX_SHIFT))
#endif
...
#define REG_G2_BG3Y_FIELD(s, integer_sy, decimal_sy)                                                                                                                                                   \
    (u32)(((u32)(s) << REG_G2_BG3Y_S_SHIFT) | ((u32)(integer_sy) << REG_G2_BG3Y_INTEGER_SY_SHIFT) | ((u32)(decimal_sy) << REG_G2_BG3Y_DECIMAL_SY_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_G2_WIN0H_FIELD(leftx, rightx) (u16)(((u32)(leftx) << REG_G2_WIN0H_LEFTX_SHIFT) | ((u32)(rightx) << REG_G2_WIN0H_RIGHTX_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_G2_WIN1H_FIELD(leftx, rightx) (u16)(((u32)(leftx) << REG_G2_WIN1H_LEFTX_SHIFT) | ((u32)(rightx) << REG_G2_WIN1H_RIGHTX_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_G2_WIN0V_FIELD(upy, downy) (u16)(((u32)(upy) << REG_G2_WIN0V_UPY_SHIFT) | ((u32)(downy) << REG_G2_WIN0V_DOWNY_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_G2_WIN1V_FIELD(upy, downy) (u16)(((u32)(upy) << REG_G2_WIN1V_UPY_SHIFT) | ((u32)(downy) << REG_G2_WIN1V_DOWNY_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_G2_WININ_FIELD(win1in, win0in) (u16)(((u32)(win1in) << REG_G2_WININ_WIN1IN_SHIFT) | ((u32)(win0in) << REG_G2_WININ_WIN0IN_SHIFT))
#endif
...
#define REG_G2_MOSAIC_FIELD(objvsize, objhsize, bgvsize, bghsize)                                                                                                                                      \
    (u16)(((u32)(objvsize) << REG_G2_MOSAIC_OBJVSIZE_SHIFT) | ((u32)(objhsize) << REG_G2_MOSAIC_OBJHSIZE_SHIFT) | ((u32)(bgvsize) << REG_G2_MOSAIC_BGVSIZE_SHIFT)                                      \
...
#ifndef SDK_ASM
#define REG_G2_BLDCNT_FIELD(plane2, effect, plane1) (u16)(((u32)(plane2) << REG_G2_BLDCNT_PLANE2_SHIFT) | ((u32)(effect) << REG_G2_BLDCNT_EFFECT_SHIFT) | ((u32)(plane1) << REG_G2_BLDCNT_PLANE1_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_G2_BLDALPHA_FIELD(evb, eva) (u16)(((u32)(evb) << REG_G2_BLDALPHA_EVB_SHIFT) | ((u32)(eva) << REG_G2_BLDALPHA_EVA_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_G2_BLDY_FIELD(evy) (u16)(((u32)(evy) << REG_G2_BLDY_EVY_SHIFT))
#endif