...
#define REG_GX_DISPCNT_FIELD(o, bg, bgscreenoffset, bgcharoffset, oh, exobj, vram, mode, ow, w1, w0, display, blank, objmap, bg02d3d, bgmode, objmap_ch, objmap_bm, exobj_ch, exobj_bm)                \
    (u32)(((u32)(o) << REG_GX_DISPCNT_O_SHIFT) | ((u32)(bg) << REG_GX_DISPCNT_BG_SHIFT) | ((u32)(bgscreenoffset) << REG_GX_DISPCNT_BGSCREENOFFSET_SHIFT)                                               \
          | ((u32)(bgcharoffset) << REG_GX_DISPCNT_BGCHAROFFSET_SHIFT) | ((u32)(oh) << REG_GX_DISPCNT_OH_SHIFT) | ((u32)(exobj) << REG_GX_DISPCNT_EXOBJ_SHIFT)                                         \
          | ((u32)(vram) << REG_GX_DISPCNT_VRAM_SHIFT) | ((u32)(mode) << REG_GX_DISPCNT_MODE_SHIFT) | ((u32)(ow) << REG_GX_DISPCNT_OW_SHIFT) | ((u32)(w1) << REG_GX_DISPCNT_W1_SHIFT)                  \
          | ((u32)(w0) << REG_GX_DISPCNT_W0_SHIFT) | ((u32)(display) << REG_GX_DISPCNT_DISPLAY_SHIFT) | ((u32)(blank) << REG_GX_DISPCNT_BLANK_SHIFT) | ((u32)(objmap) << REG_GX_DISPCNT_OBJMAP_SHIFT)  \
          | ((u32)(bg02d3d) << REG_GX_DISPCNT_BG02D3D_SHIFT) | ((u32)(bgmode) << REG_GX_DISPCNT_BGMODE_SHIFT) | ((u32)(objmap_ch) << REG_GX_DISPCNT_OBJMAP_CH_SHIFT)                                   \
          | ((u32)(objmap_bm) << REG_GX_DISPCNT_OBJMAP_BM_SHIFT) | ((u32)(exobj_ch) << REG_GX_DISPCNT_EXOBJ_CH_SHIFT) | ((u32)(exobj_bm) << REG_GX_DISPCNT_EXOBJ_BM_SHIFT))
#endif
...
#define REG_GX_DISPSTAT_FIELD(vcounter, vqi, hbi, vbi, lyc, hblk, vblk)                                                                                                                                \
    (u16)(((u32)(vcounter) << REG_GX_DISPSTAT_VCOUNTER_SHIFT) | ((u32)(vqi) << REG_GX_DISPSTAT_VQI_SHIFT) | ((u32)(hbi) << REG_GX_DISPSTAT_HBI_SHIFT) | ((u32)(vbi) << REG_GX_DISPSTAT_VBI_SHIFT)      \
          | ((u32)(lyc) << REG_GX_DISPSTAT_LYC_SHIFT) | ((u32)(hblk) << REG_GX_DISPSTAT_HBLK_SHIFT) | ((u32)(vblk) << REG_GX_DISPSTAT_VBLK_SHIFT))
#endif
