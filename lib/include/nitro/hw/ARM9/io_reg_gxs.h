...
#define REG_GXS_DB_DISPCNT_FIELD(o, bg, oh, exobj, mode, ow, w1, w0, display, blank, objmap, bgmode, objmap_ch, objmap_bm, exobj_ch)                                                                   \
    (u32)(((u32)(o) << REG_GXS_DB_DISPCNT_O_SHIFT) | ((u32)(bg) << REG_GXS_DB_DISPCNT_BG_SHIFT) | ((u32)(oh) << REG_GXS_DB_DISPCNT_OH_SHIFT) | ((u32)(exobj) << REG_GXS_DB_DISPCNT_EXOBJ_SHIFT)        \
          | ((u32)(mode) << REG_GXS_DB_DISPCNT_MODE_SHIFT) | ((u32)(ow) << REG_GXS_DB_DISPCNT_OW_SHIFT) | ((u32)(w1) << REG_GXS_DB_DISPCNT_W1_SHIFT) | ((u32)(w0) << REG_GXS_DB_DISPCNT_W0_SHIFT)      \
          | ((u32)(display) << REG_GXS_DB_DISPCNT_DISPLAY_SHIFT) | ((u32)(blank) << REG_GXS_DB_DISPCNT_BLANK_SHIFT) | ((u32)(objmap) << REG_GXS_DB_DISPCNT_OBJMAP_SHIFT)                               \
          | ((u32)(bgmode) << REG_GXS_DB_DISPCNT_BGMODE_SHIFT) | ((u32)(objmap_ch) << REG_GXS_DB_DISPCNT_OBJMAP_CH_SHIFT) | ((u32)(objmap_bm) << REG_GXS_DB_DISPCNT_OBJMAP_BM_SHIFT)                   \
...
#ifndef SDK_ASM
#define REG_GXS_DB_MASTER_BRIGHT_FIELD(e_mod, e_value) (u16)(((u32)(e_mod) << REG_GXS_DB_MASTER_BRIGHT_E_MOD_SHIFT) | ((u32)(e_value) << REG_GXS_DB_MASTER_BRIGHT_E_VALUE_SHIFT))
#endif