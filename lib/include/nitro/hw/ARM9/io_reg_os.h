...
#define REG_OS_IE_FIELD(gf, mi, mc, ifn, ife, a7, i_d, k, d3, d2, d1, d0, t3, t2, t1, t0, ve, hb, vb)                                                                                                  \
    (u32)(((u32)(gf) << REG_OS_IE_GF_SHIFT) | ((u32)(mi) << REG_OS_IE_MI_SHIFT) | ((u32)(mc) << REG_OS_IE_MC_SHIFT) | ((u32)(ifn) << REG_OS_IE_IFN_SHIFT) | ((u32)(ife) << REG_OS_IE_IFE_SHIFT)        \
          | ((u32)(a7) << REG_OS_IE_A7_SHIFT) | ((u32)(i_d) << REG_OS_IE_I_D_SHIFT) | ((u32)(k) << REG_OS_IE_K_SHIFT) | ((u32)(d3) << REG_OS_IE_D3_SHIFT) | ((u32)(d2) << REG_OS_IE_D2_SHIFT)          \
          | ((u32)(d1) << REG_OS_IE_D1_SHIFT) | ((u32)(d0) << REG_OS_IE_D0_SHIFT) | ((u32)(t3) << REG_OS_IE_T3_SHIFT) | ((u32)(t2) << REG_OS_IE_T2_SHIFT) | ((u32)(t1) << REG_OS_IE_T1_SHIFT)          \
          | ((u32)(t0) << REG_OS_IE_T0_SHIFT) | ((u32)(ve) << REG_OS_IE_VE_SHIFT) | ((u32)(hb) << REG_OS_IE_HB_SHIFT) | ((u32)(vb) << REG_OS_IE_VB_SHIFT))
#endif
...
#define REG_OS_IF_FIELD(gf, mi, mc, ifn, ife, a7, i_d, k, d3, d2, d1, d0, t3, t2, t1, t0, ve, hb, vb)                                                                                                  \
    (u32)(((u32)(gf) << REG_OS_IF_GF_SHIFT) | ((u32)(mi) << REG_OS_IF_MI_SHIFT) | ((u32)(mc) << REG_OS_IF_MC_SHIFT) | ((u32)(ifn) << REG_OS_IF_IFN_SHIFT) | ((u32)(ife) << REG_OS_IF_IFE_SHIFT)        \
          | ((u32)(a7) << REG_OS_IF_A7_SHIFT) | ((u32)(i_d) << REG_OS_IF_I_D_SHIFT) | ((u32)(k) << REG_OS_IF_K_SHIFT) | ((u32)(d3) << REG_OS_IF_D3_SHIFT) | ((u32)(d2) << REG_OS_IF_D2_SHIFT)          \
          | ((u32)(d1) << REG_OS_IF_D1_SHIFT) | ((u32)(d0) << REG_OS_IF_D0_SHIFT) | ((u32)(t3) << REG_OS_IF_T3_SHIFT) | ((u32)(t2) << REG_OS_IF_T2_SHIFT) | ((u32)(t1) << REG_OS_IF_T1_SHIFT)          \
          | ((u32)(t0) << REG_OS_IF_T0_SHIFT) | ((u32)(ve) << REG_OS_IF_VE_SHIFT) | ((u32)(hb) << REG_OS_IF_HB_SHIFT) | ((u32)(vb) << REG_OS_IF_VB_SHIFT))
#endif
