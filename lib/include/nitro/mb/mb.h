#ifndef NITRO_MB_MB_H
#define NITRO_MB_MB_H
...
void MB_ReadMultiBootParentBssDesc(WMBssDesc *p_desc, u16 parent_max_size, u16 child_max_size, BOOL ks_flag, BOOL cs_flag);
