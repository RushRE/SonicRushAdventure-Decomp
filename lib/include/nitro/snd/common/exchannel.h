#ifndef NITRO_SND_COMMON_EX_CHANNEL_H
#define NITRO_SND_COMMON_EX_CHANNEL_H
...
struct SNDExChannel *SND_AllocExChannel(u32 chBitMask, int prio, BOOL strongRequest, SNDExChannelCallback callback, void *callbackData);
...
#endif // NITRO_SND_COMMON_EX_CHANNEL_H
