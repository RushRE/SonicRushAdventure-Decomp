...
#define WBT_PACKET_BITMAP_SIZE(block_size, packet_size) (((((block_size) + ((packet_size)-WBT_PACKET_SIZE_MIN) - 1) / ((packet_size)-WBT_PACKET_SIZE_MIN)) + 31) / sizeof(u32)) * sizeof(u32)
