#ifndef NNS_FND_FRAMEHEAP_H
#define NNS_FND_FRAMEHEAP_H
...
#define NNS_FndCreateFrmHeap(startAddress, size) NNS_FndCreateFrmHeapEx(startAddress, size, 0)
#define NNS_FndAllocFromFrmHeap(heap, size) NNS_FndAllocFromFrmHeapEx(heap, size, NNS_FND_HEAP_DEFAULT_ALIGNMENT)
#define NNS_FndGetAllocatableSizeForFrmHeap(heap) NNS_FndGetAllocatableSizeForFrmHeapEx(heap, NNS_FND_HEAP_DEFAULT_ALIGNMENT)
