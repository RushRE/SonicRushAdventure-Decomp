#ifndef NNS_G2D_CELL_DATA_H
#define NNS_G2D_CELL_DATA_H
...
{
    return (u16)((bH << NNS_G2D_CELL_FLIP_H_SHIFT) | (bV << NNS_G2D_CELL_FLIP_V_SHIFT) | (bHV << NNS_G2D_CELL_FLIP_HV_SHIFT));
}
