#ifndef NNS_G2D_CHARACTER_DATA_H
#define NNS_G2D_CHARACTER_DATA_H
...
{
    return (u32)((charFmt << NNS_G2D_CHARACTER_FMT_SHIFT) | (bVramTransferData << NNS_G2D_VRAMTRANSFERDATA_FLAG_SHIFT));
}

NNS_G2D_INLINE NNSG2dCharacterFmt NNSi_G2dGetCharacterFmtType(u32 characterFmt)
{
    return (NNSG2dCharacterFmt)(NNS_G2D_CHARACTER_FMT_MASK & (characterFmt >> NNS_G2D_CHARACTER_FMT_SHIFT));
}

NNS_G2D_INLINE BOOL NNSi_G2dIsCharacterVramTransfered(u32 characterFmt)
{
    return (BOOL)(NNS_G2D_VRAMTRANSFERDATA_FLAG_MASK & (characterFmt >> NNS_G2D_VRAMTRANSFERDATA_FLAG_SHIFT));
}
...
#endif // NNS_G2D_CHARACTER_DATA_H