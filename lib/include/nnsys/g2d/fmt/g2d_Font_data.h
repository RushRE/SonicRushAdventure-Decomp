#ifndef NNS_G2D_FONT_DATA_H
#define NNS_G2D_FONT_DATA_H
...
typedef struct NNSG2dFontWidthOld
{
    u16 indexBegin;
    u16 indexEnd;
    struct NNSG2dFontWidthOld *pNext;
    NNSG2dCharWidthsOld widthTable[];
} NNSG2dFontWidthOld;
...
typedef struct NNSG2dFontInformationOld
{
    ...
    s8 linefeed;
    u16 alterCharIndex;
    NNSG2dCharWidthsOld defaultWidth;
    u8 encoding;
    u8 reserved;
    NNSG2dFontGlyph *pGlyph;
    NNSG2dFontWidthOld *pWidth;
    NNSG2dFontCodeMap *pMap;
