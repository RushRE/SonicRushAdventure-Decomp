#ifndef G2D_TEXTCANVAS_H
#define G2D_TEXTCANVAS_H
...
{
    return NNSi_G2dFontGetTextWidth(pTxn->pFont, pTxn->hSpace, txt);
}
...
NNS_G2D_INLINE void NNS_G2dTextCanvasDrawText(const NNSG2dTextCanvas *pTxn, int x, int y, int cl, u32 flags, const void *txt)
{
