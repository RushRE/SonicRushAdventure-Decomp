#ifndef NNSG3D_GLBSTATE_INLINE_H
#define NNSG3D_GLBSTATE_INLINE_H
...
NNS_G3D_INLINE void NNS_G3dGlbLookAt(const VecFx32 *camPos, const VecFx32 *camUp, const VecFx32 *target)
{
    ...
    NNS_G3dGlb.flag &= ~(NNS_G3D_GLB_FLAG_INVCAMERA_UPTODATE | NNS_G3D_GLB_FLAG_BASECAMERA_UPTODATE | NNS_G3D_GLB_FLAG_INVBASECAMERA_UPTODATE | NNS_G3D_GLB_FLAG_INVCAMERAPROJ_UPTODATE);
}
...
#endif // NNSG3D_GLBSTATE_INLINE_H
