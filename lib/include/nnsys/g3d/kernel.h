#ifndef NNSG3D_KERNEL_H
#define NNSG3D_KERNEL_H
...
#define NNS_G3D_RENDEROBJ_JNTBUFFER_SIZE(numJnt) ((u32)(sizeof(NNSG3dJntAnmResult) * (numJnt)))

#define NNS_G3D_RENDEROBJ_MATBUFFER_SIZE(numMat) ((u32)(sizeof(NNSG3dMatAnmResult) * (numMat)))
