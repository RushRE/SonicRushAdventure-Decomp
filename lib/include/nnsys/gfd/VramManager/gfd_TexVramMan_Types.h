#ifndef NNS_GFD_TEXVRAMMAN_TYPES_H
#define NNS_GFD_TEXVRAMMAN_TYPES_H
...
{
    return ((size >> NNS_GFD_TEXKEY_SIZE_SHIFT) << 16) | ((NNS_GFD_MASK_16BIT & (addr >> NNS_GFD_TEXKEY_ADDR_SHIFT))) | b4x4Comp << 31;
}
...
#endif // NNS_GFD_TEXVRAMMAN_TYPES_H