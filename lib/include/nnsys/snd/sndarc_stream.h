#ifndef NNS_SND_SNDARC_STREAM_H
#define NNS_SND_SNDARC_STREAM_H
...
BOOL NNS_SndArcStrmStartEx2(struct NNSSndStrmHandle *handle, int playerNo, int playerPrio, int strmNo, u32 offset, NNSSndStrmCallback strmCallback, void *strmCallbackArg,
...
OSThread *NNSi_SndArcStrmGetThread(void);

#ifdef __cplusplus
}
#endif

#endif // NNS_SND_SNDARC_STREAM_H
