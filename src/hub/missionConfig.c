...
static const u16 sMissionIslandTable_Daikun[] = { MISSION_INVALID, SAVE_ISLAND_HIDDEN_ISLAND_13, SAVE_ISLAND_HIDDEN_ISLAND_15 };
...
static const u16 sMissionIslandTable_Setter[] = { SAVE_ISLAND_HIDDEN_ISLAND_9,  SAVE_ISLAND_HIDDEN_ISLAND_10, SAVE_ISLAND_HIDDEN_ISLAND_7,
                                                  SAVE_ISLAND_HIDDEN_ISLAND_14, SAVE_ISLAND_HIDDEN_ISLAND_16, SAVE_ISLAND_HIDDEN_ISLAND_11 };

static const u16 sMissionTable_Gardon[7] = { MISSION_19, MISSION_77, MISSION_29, MISSION_86, MISSION_81, MISSION_69, MISSION_71 };

static const u16 sMissionIslandTable_Gardon[] = {
    MISSION_INVALID, SAVE_ISLAND_HIDDEN_ISLAND_6, MISSION_INVALID, SAVE_ISLAND_HIDDEN_ISLAND_12, SAVE_ISLAND_HIDDEN_ISLAND_8, MISSION_INVALID, MISSION_INVALID
};
...
{
    u16 id = MissionHelpers__GetInteractionForMission(ARRAY_COUNT(sMissionTable_Setter), sMissionTable_Setter, (const u16 *)sMissionProgressTable_Setter,
                                                      sMissionIslandTable_Setter, sMissionValueTable_Setter);
