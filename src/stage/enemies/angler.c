...
EnemyAngler *CreateAngler(MapObject *mapObject, fx32 x, fx32 y, fx32 type)
{
    ...
    ObjObjectAction2dBACLoad(&work->gameWork.objWork, &work->gameWork.animator, sSpriteList[0], GetObjectDataWork(OBJDATAWORK_9), gGameArchiveStage, OBJ_DATA_GFX_AUTO);
