...
DashPanel *CreateDashPanel(MapObject *mapObject, fx32 x, fx32 y, fx32 type)
{
    ...
    ObjRect__SetOnDefend(&work->gameWork.colliders[GAMEOBJECT_COLLIDER_WEAK], DashPanel_OnDefend);
...
void DashPanel_OnDefend(OBS_RECT_WORK *rect1, OBS_RECT_WORK *rect2)
{
    ...
    {
        dashPanel->gameWork.colliders[GAMEOBJECT_COLLIDER_WEAK].flag &= ~OBS_RECT_WORK_FLAG_SYS_WILL_DEF_THIS_FRAME;
