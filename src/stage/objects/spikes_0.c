...
extern void SetSpikesAnimation(Spikes *work, u16 anim);

extern void Spikes_Action_Idle(Spikes *work);
...
{
    // https://decomp.me/scratch/TnU5n -> 97.14%
#ifdef NON_MATCHING
    ...
    ObjObjectAction2dBACLoad(&work->gameWork.objWork, &work->gameWork.animator, "/act/ac_gmk_needle.bac", GetObjectFileWork(OBJDATAWORK_28), gGameArchiveStage, OBJ_DATA_GFX_NONE);
    ...
    ObjRect__SetDefenceStat(&work->gameWork.colliders[0], OBS_RECT_ATTR_NO_HIT(OBS_RECT_WORK_ATTR_BODY), OBS_RECT_DEFPOWER_INVINCIBLE);
